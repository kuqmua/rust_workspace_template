...
fn validate_commit_header_value(
    commit: crate::domain_types::hdr_val::HeaderStrRef<'_>,
) -> Result<(), CommitError> {
...
mod tests {
    fn check_commit_enabled(headers: &axum::http::HeaderMap) -> Result<(), super::CommitError> {
        super::check_commit(
            true.into(),
            crate::domain_types::hdr_val::AxumHeadersRef::from(headers),
        )
    }
    ...
    {
        crate::domain_types::test_hlp::mk_headers_with_entry(super::COMMIT_HEADER_NAME, value)
    }
    fn mk_headers_with_commit(commit: &str) -> crate::domain_types::test_hlp::AxumTestHeaders {
        mk_headers_with_commit_header_value(
            axum::http::HeaderValue::from_str(commit)
                .expect("9f2db59c mk_headers_with_commit invariant must hold"),
        )
    }
    fn mk_headers_with_wrong_commit() -> crate::domain_types::test_hlp::AxumTestHeaders {
        mk_headers_with_commit(constants_str::TEST_VALUES_WRONG_COMMIT)
    }
    fn mk_headers_with_project_commit() -> crate::domain_types::test_hlp::AxumTestHeaders {
        mk_headers_with_commit(git_info::domain_types::project_git_info().commit().as_ref())
    }
    fn mk_headers_with_non_utf8_commit() -> crate::domain_types::test_hlp::AxumTestHeaders {
        mk_headers_with_commit_header_value(crate::domain_types::test_hlp::non_utf8_header_value())
    }
    fn check_commit_ok(
        ...
        crate::domain_types::test_hlp::expect_ok(
            super::check_commit(
    ...
    fn expect_check_commit_err_variant<R>(
        ...
        crate::domain_types::test_hlp::expect_err_variant_ref_with_status(
            check_commit_enabled(headers),
            exp_id,
    ...
    fn get_commit_header_str_returns_header_value_when_present() {
        ...
        crate::domain_types::test_hlp::assert_ok_eq(
            ...
            .map(crate::domain_types::hdr_val::HeaderStrRef::get),
    ...
    fn validate_commit_header_returns_error_when_header_is_absent() {
        let headers = axum::http::HeaderMap::new();
        let no_commit_header = crate::domain_types::test_hlp::expect_error_variant_ref(
            super::validate_commit_header(crate::domain_types::hdr_val::AxumHeadersRef::from(
                &headers,
            )),
    ...
    fn validate_commit_header_value_returns_mismatch_for_wrong_commit() {
        let fields = crate::domain_types::test_hlp::expect_error_variant_ref(
            super::validate_commit_header_value(crate::domain_types::hdr_val::HeaderStrRef::from(
    ...
    fn check_commit_accepts_header_name_with_different_case() {
        ...
        crate::domain_types::test_hlp::replace_header_name(
            &mut headers,
