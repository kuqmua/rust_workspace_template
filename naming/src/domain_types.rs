proc_macro_naming_generate_upper_camel_case_and_snake_case_str_and_token_stream::generate_upper_camel_case_and_snake_case_str_and_token_stream!(
    [
        ["primary", "key"],
        ["serde"],
        ["with", "serde"],
        ...
        ["dimension", "one", "all", "elements", "eq"],
        ["dimension", "two", "all", "elements", "eq"],
        ["dimension", "three", "all", "elements", "eq"],
        ["dimension", "four", "all", "elements", "eq"],
        ...
        ["dimension", "one", "all", "elements", "regex"],
        ["dimension", "two", "all", "elements", "regex"],
        ["dimension", "three", "all", "elements", "regex"],
        ["dimension", "four", "all", "elements", "regex"],
        ["dimension", "one", "eq"],
        ["dimension", "two", "eq"],
        ["dimension", "three", "eq"],
        ["dimension", "four", "eq"],
