...
pub fn impl_try_from_non_empty_string(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    quote::quote! {
        #[derive(Debug, Clone, proc_macro_getters::Getters, proc_macro_generate_accessor_traits_for_struct_fields::GenerateAccessorTrait, proc_macro_optimal_memory_layout::OptimalMemoryLayout)]
...
pub fn impl_try_from_secret_url(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let error_name = quote::format_ident!("{error_name_text}");
    quote::quote! {
        #[derive(Debug, proc_macro_getters::Getters, proc_macro_generate_accessor_traits_for_struct_fields::GenerateAccessorTrait, proc_macro_optimal_memory_layout::OptimalMemoryLayout)]
...
fn impl_try_from_parse_with_error_ty(
    ...
    proc_macro_try_from_parse_token_stream::ProcMacroTryFromParseTokenStream::from(
        proc_macro::TokenStream::from(quote::quote! {
            #[derive(Debug, #(#derives,)* proc_macro_getters::Getters, proc_macro_generate_accessor_traits_for_struct_fields::GenerateAccessorTrait, proc_macro_optimal_memory_layout::OptimalMemoryLayout)]
