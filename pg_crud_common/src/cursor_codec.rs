...
pub struct CursorCodec {
    key: crate::domain_types::CursorSigningKey,
...
impl CursorCodec {
    ...
    pub fn encode(
        &self,
        payload: &crate::domain_types::CursorPayload,
    ) -> Result<crate::domain_types::SignedCursor, crate::domain_types::CursorEncodeError> {
        ...
        let mut mac =
            <hmac::Hmac<sha2::Sha256> as hmac::KeyInit>::new_from_slice(self.key.0.as_slice())
                .map_err(|_error| crate::domain_types::CursorEncodeError::InvalidSigningKey)?;
        ...
        crate::domain_types::SignedCursor::try_from(cursor_text)
            .map_err(|_error| crate::domain_types::CursorEncodeError::MaximumLengthExceeded)
    }
    ...
    pub fn decode(
        ...
        let version = parts
            .next()
            .ok_or(crate::domain_types::CursorDecodeError::InvalidFormat)?;
        ...
        if parts.next().is_some() || version != constants_str::CURSOR_VERSION_V1 {
            return Err(crate::domain_types::CursorDecodeError::InvalidFormat);
        }
        let signature = base64::Engine::decode(
            &base64::engine::general_purpose::URL_SAFE_NO_PAD,
            encoded_signature,
        )
        .map_err(|_error| crate::domain_types::CursorDecodeError::InvalidSignature)?;
        let mut mac =
            <hmac::Hmac<sha2::Sha256> as hmac::KeyInit>::new_from_slice(self.key.0.as_slice())
                .map_err(|_error| crate::domain_types::CursorDecodeError::InvalidSigningKey)?;
        ...
        .map_err(|_error| crate::domain_types::CursorDecodeError::InvalidPayload)?;
        let payload_text = String::from_utf8(payload_bytes)
            .map_err(|_error| crate::domain_types::CursorDecodeError::InvalidPayload)?;
        crate::domain_types::CursorPayload::try_from(payload_text)
            .map_err(|_error| crate::domain_types::CursorDecodeError::InvalidPayload)
    }
}
...
mod tests {
    proptest::proptest! {
        ...
        fn signed_cursor_round_trips_generated_payloads(payload_text in constants_str::TEST_CURSOR_PAYLOAD_PATTERN) {
            let domain_payload = crate::domain_types::CursorPayload::try_from(payload_text).expect(constants_str::VALUE_28167829);
        ...
        fn changing_signature_is_always_rejected(payload_text in constants_str::TEST_CURSOR_PAYLOAD_PATTERN) {
            let domain_payload = crate::domain_types::CursorPayload::try_from(payload_text).expect(constants_str::VALUE_52BB899A);
            ...
            *signature_byte = if *signature_byte == b'A' { b'B' } else { b'A' };
            ...
            let modified_cursor = crate::domain_types::SignedCursor::try_from(modified_text).expect(constants_str::VALUE_D1169A2F);
            proptest::prop_assert_eq!(codec().decode(&modified_cursor), Err(crate::domain_types::CursorDecodeError::InvalidSignature));
        }
    }

    fn codec() -> super::CursorCodec {
        super::CursorCodec::new(
            crate::domain_types::CursorSigningKey::try_from(vec![7u8; 32usize])
                .expect("556f25ae codec invariant must hold"),
            crate::domain_types::CursorMaximumLength::try_from(1_024usize)
    ...
    fn signed_cursor_round_trip_preserves_payload() {
        let payload = crate::domain_types::CursorPayload::try_from(String::from(
    ...
    fn modified_cursor_is_rejected() {
        ...
        let modified = crate::domain_types::SignedCursor::try_from(format!("{}x", cursor.as_ref()))
            .expect("64b5f541 modified_cursor_is_rejected invariant must hold");
        assert_eq!(
            codec().decode(&modified),
            Err(crate::domain_types::CursorDecodeError::InvalidSignature)
        );
    }
}
