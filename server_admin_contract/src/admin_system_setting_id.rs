...
pub struct AdminSystemSettingId(crate::positive_non_zero_i64::PositiveNonZeroI64);
impl TryFrom<i64> for AdminSystemSettingId {
...
impl From<AdminSystemSettingId> for i64 {
    fn from(value: AdminSystemSettingId) -> Self {
        value.0.get()
    }
}
impl AdminSystemSettingId {
    #[must_use]
    pub fn from_frontend_path(
        admin_page_path_ref: crate::admin_page_path_ref::AdminPagePathRef<'_>,
    ) -> Option<Self> {
        admin_page_path_ref
            .record_id(crate::admin_data_table::AdminDataTable::SystemSettings)
            .map(Self::from)
    }
}
...
mod tests {
    #[test]
    fn test_system_setting_identifier_parses_from_detail_frontend_path() {
        assert_eq!(
            super::AdminSystemSettingId::try_from(0i64),
            Err(crate::admin_id_try_from_i64_error::AdminIdTryFromI64Error::Invalid)
        );
        let expected_identifier_result = super::AdminSystemSettingId::try_from(7i64);
        assert_eq!(
        ...
        expected_identifier_result
            ...
            .for_each(|expected_identifier| {
                ...
                let identifier = super::AdminSystemSettingId::from_frontend_path(
