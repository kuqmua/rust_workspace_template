...
fn authenticated_admin_checks_owned_permissions() {
    let admin = super::AuthenticatedAdmin::new(
        crate::AdminDisplayName::try_from(str_constants::ADMIN.to_owned()).expect("68e94b2f"),
        crate::AdminUserId::try_from(1i64).expect("134f7a9c"),
        crate::AdminLogin::try_from(str_constants::ROOT.to_owned()).expect("971c5e42"),
        ...
        .expect("bd2806f1"),
        crate::AdminRoleNames::try_from(Vec::new()).expect("763ae20c"),
    );
    assert!(bool::from(
...
fn change_own_password_has_no_session_revocation_choice() {
    let request = crate::AdminChangeOwnPasswordReq::new(
        crate::AdminPassword::try_from(String::from("Current-password1")).expect("c10e4db7"),
        crate::AdminNewPassword::try_from(String::from("New-password2")).expect("5932a1fe"),
    );
...
fn passwords_are_redacted_and_share_policy() {
    let password =
        crate::AdminPassword::try_from(String::from(str_constants::SECRET)).expect("9f3f5164");
...
fn domain_values_follow_database_compatible_policies() {
    let _valid_login =
        crate::AdminLogin::try_from(str_constants::ADMIN_USER_1.to_owned()).expect("e1cddebc");
    ...
    let _valid_display_name =
        crate::AdminDisplayName::try_from(str_constants::ADMIN.to_owned()).expect("d315b74f");
    ...
    let _valid_role_name =
        crate::AdminRoleName::try_from(str_constants::ADMIN_ALT.to_owned()).expect("713890e9");
