...
pub struct AdminLoginAttemptId(crate::positive_non_zero_i64::PositiveNonZeroI64);
impl TryFrom<i64> for AdminLoginAttemptId {
...
impl From<AdminLoginAttemptId> for i64 {
    fn from(value: AdminLoginAttemptId) -> Self {
        value.0.get()
    }
}
...
mod tests {
    #[test]
    fn test_login_attempt_identifier_parses_from_detail_frontend_path() {
        assert_eq!(
            super::AdminLoginAttemptId::try_from(0i64),
            Err(crate::admin_id_try_from_i64_error::AdminIdTryFromI64Error::Invalid)
        );
        let expected_identifier_result = super::AdminLoginAttemptId::try_from(7i64);
        assert_eq!(
