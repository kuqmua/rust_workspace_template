...
pub struct AdminRateLimitId(crate::positive_non_zero_i64::PositiveNonZeroI64);

impl TryFrom<i64> for AdminRateLimitId {
...
impl From<AdminRateLimitId> for i64 {
    fn from(value: AdminRateLimitId) -> Self {
        value.0.get()
    }
}
...
impl AdminRateLimitId {
    ...
    pub fn from_frontend_path(
        ...
        admin_page_path_ref
            .record_id(crate::admin_data_table::AdminDataTable::RateLimits)
            .map(Self::from)
    }
}
...
mod tests {
    ...
    fn test_rate_limit_identifier_parses_from_detail_frontend_path() {
        let expected_identifier_result = super::AdminRateLimitId::try_from(constants_i64::ONE);
        assert_eq!(
