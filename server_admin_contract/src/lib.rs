...
pub mod admin_change_own_password_req;
pub mod admin_change_own_password_route;
pub mod admin_collection_error;
pub mod admin_collection_max_items;
pub mod admin_create_role_req;
pub mod admin_create_role_res;
pub mod admin_create_role_route;
pub mod admin_create_user_req;
pub mod admin_create_user_res;
...
pub mod admin_set_role_permissions_req;
pub mod admin_set_role_permissions_route;
pub mod admin_set_user_ban_req;
pub mod admin_set_user_ban_route;
pub mod admin_set_user_password_req;
pub mod admin_set_user_password_route;
pub mod admin_set_user_roles_req;
...
pub mod admin_sign_in_req;
pub mod admin_sign_in_res;
...
pub mod admin_text;
pub mod admin_texts;
pub mod admin_update_role_req;
pub mod admin_update_role_route;
pub mod admin_update_settings_req;
pub mod admin_update_settings_route;
pub mod admin_update_user_req;
