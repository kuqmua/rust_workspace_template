...
str_constants_macros::define_str_constants! {
    fragments {
        ...
        WORD_ADMIN_MIGRATION_UPGRADE_TEST = "admin_migration_upgrade_test";
        ...
        WORD_LEGACY_ADMIN_AUDIT_LOG = "admin_audit_log";
    ...
    constants {
        ...
        pub DENY = ["DENY"];
        pub DROP_SCHEMA_IF_EXISTS_ADMIN_MIGRATION_FRESH_TEST_CASCADE_DROP_SCHEMA_IF = [WORD_DROP, " ", WORD_SCHEMA, " ", WORD_IF, " ", WORD_EXISTS, " ", WORD_ADMIN_MIGRATION_FRESH_TEST, " ", WORD_CASCADE, "; ", WORD_DROP, " ", WORD_SCHEMA, " ", WORD_IF, " ", WORD_EXISTS, " ", WORD_ADMIN_MIGRATION_UPGRADE_TEST, " ", WORD_CASCADE];
        pub DROP_SCHEMA_ADMIN_MIGRATION_FRESH_TEST_CASCADE_DROP_SCHEMA_ADMIN_MIGRATION_UPGRADE = [WORD_DROP, " ", WORD_SCHEMA, " ", WORD_ADMIN_MIGRATION_FRESH_TEST, " ", WORD_CASCADE, "; ", WORD_DROP, " ", WORD_SCHEMA, " ", WORD_ADMIN_MIGRATION_UPGRADE_TEST, " ", WORD_CASCADE];
        ...
        pub SELECT_SELECT_MAX_VERSION_FROM_ADMIN_MIGRATION_FRESH_TEST_SQLX_MIGRATIONS_WHERE = [WORD_SELECT, " (", WORD_SELECT, " ", WORD_MAX, "(", WORD_VERSION, ") ", WORD_FROM, " ", WORD_ADMIN_MIGRATION_FRESH_TEST, "._", WORD_SQLX_MIGRATIONS, " ", WORD_WHERE, " ", WORD_SUCCESS, " = ", WORD_TRUE, "),(", WORD_SELECT, " ", WORD_MAX, "(", WORD_VERSION, ") ", WORD_FROM, " ", WORD_ADMIN_MIGRATION_UPGRADE_TEST, "._", WORD_SQLX_MIGRATIONS, " ", WORD_WHERE, " ", WORD_SUCCESS, " = ", WORD_TRUE, ")"];
        ...
        pub ADMIN_MIGRATION_UPGRADE_TEST = [WORD_ADMIN_MIGRATION_UPGRADE_TEST];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_001 = [WORD_LEGACY_ADMIN_AUDIT_LOG, "_append_", WORD_ONLY];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_002 = [WORD_ADMIN_2, "_", WORD_SET_2, "_updated_", WORD_AT];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_003 = [WORD_LEGACY_ADMIN_AUDIT_LOG, "_append_", WORD_ONLY, "_guard"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_004 = [WORD_ADMIN_AUDIT_LOG, ":BEFORE:", WORD_DELETE, ":EXECUTE FUNCTION ", WORD_LEGACY_ADMIN_AUDIT_LOG, "_append_", WORD_ONLY, "()"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_005 = [WORD_ADMIN_AUDIT_LOG, ":BEFORE:", WORD_UPDATE, ":EXECUTE FUNCTION ", WORD_LEGACY_ADMIN_AUDIT_LOG, "_append_", WORD_ONLY, "()"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_006 = [WORD_LEGACY_ADMIN_ROLES, "_", WORD_SET_2, "_updated_", WORD_AT];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_007 = [WORD_ADMIN_ROLES, ":BEFORE:", WORD_UPDATE, ":EXECUTE FUNCTION ", WORD_ADMIN_2, "_", WORD_SET_2, "_updated_", WORD_AT, "()"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_008 = [WORD_LEGACY_ADMIN_SYSTEM_SETTINGS, "_", WORD_SET_2, "_updated_", WORD_AT];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_009 = [WORD_ADMIN_SYSTEM_SETTINGS, ":BEFORE:", WORD_UPDATE, ":EXECUTE FUNCTION ", WORD_ADMIN_2, "_", WORD_SET_2, "_updated_", WORD_AT, "()"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_010 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_SET_2, "_updated_", WORD_AT];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_011 = [WORD_ADMIN_USERS, ":BEFORE:", WORD_UPDATE, ":EXECUTE FUNCTION ", WORD_ADMIN_2, "_", WORD_SET_2, "_updated_", WORD_AT, "()"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_015 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_DISPLAY_NAME, "_", WORD_LENGTH];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_017 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_DISPLAY_NAME, "_trimmed"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_018 = [WORD_CHECK, " (", WORD_DISPLAY_NAME, " = btrim(", WORD_DISPLAY_NAME, "))"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_019 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_LOGIN, "_", WORD_FORMAT];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_021 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_LOGIN, "_", WORD_LENGTH];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_022 = [WORD_CHECK, " (char_", WORD_LENGTH, "(", WORD_LOGIN, ") >= 3 ", WORD_AND, " char_", WORD_LENGTH, "(", WORD_LOGIN, ") <= 128)"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_023 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_PASSWORD_HASH, "_", WORD_NOT_2, "_", WORD_EMPTY];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_024 = [WORD_CHECK, " (char_", WORD_LENGTH, "(", WORD_PASSWORD_HASH, ") > 0)"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_025 = [WORD_LEGACY_ADMIN_USERS, "_", WORD_LOGIN, "_", WORD_LOWER, "_unq"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_026 = [WORD_CREATE, " UNIQUE INDEX ", WORD_LEGACY_ADMIN_USERS, "_", WORD_LOGIN, "_", WORD_LOWER, "_unq ", WORD_ON, " ", WORD_PUBLIC, ".", WORD_ADMIN_USERS, " ", WORD_USING, " btree (", WORD_LOWER, "(", WORD_LOGIN, "))"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_027 = [WORD_IS_SYSTEM];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_028 = [WORD_LEGACY_ADMIN_ROLES, "_", WORD_NAME_2, "_", WORD_FORMAT];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_030 = [WORD_LEGACY_ADMIN_ROLES, "_", WORD_NAME_2, "_", WORD_LENGTH];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_032 = [WORD_LEGACY_ADMIN_PERMISSIONS, "_", WORD_NAME_2, "_", WORD_FORMAT];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_034 = [WORD_LEGACY_ADMIN_PERMISSIONS, "_", WORD_NAME_2, "_", WORD_LENGTH];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_036 = [WORD_LEGACY_ADMIN_USER_ROLES, "_", WORD_ROLE_ID, "_idx"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_037 = [WORD_CREATE, " INDEX ", WORD_LEGACY_ADMIN_USER_ROLES, "_", WORD_ROLE_ID, "_idx ", WORD_ON, " ", WORD_PUBLIC, ".", WORD_ADMIN_USER_ROLES, " ", WORD_USING, " btree (", WORD_ROLE_ID, ")"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_038 = [WORD_LEGACY_ADMIN_ROLE_PERMISSIONS, "_", WORD_PERMISSION_ID, "_idx"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_039 = [WORD_CREATE, " INDEX ", WORD_LEGACY_ADMIN_ROLE_PERMISSIONS, "_", WORD_PERMISSION_ID, "_idx ", WORD_ON, " ", WORD_PUBLIC, ".", WORD_ADMIN_ROLE_PERMISSIONS, " ", WORD_USING, " btree (", WORD_PERMISSION_ID, ")"];
        ...
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_046 = [WORD_LEGACY_ADMIN_SYSTEM_SETTINGS, "_default_", WORD_ROUTE, "_", WORD_FORMAT];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_047 = [WORD_CHECK, " (", WORD_DEFAULT_ADMIN_ROUTE, " ~~ '/", WORD_ADMIN_2, "%'::", WORD_TEXT_2, ")"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_048 = [WORD_LEGACY_ADMIN_SYSTEM_SETTINGS, "_singleton"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_049 = [WORD_CHECK, " (", WORD_ID, " = 1)"];
        pub SERVER_ADMIN_DB_SCHEMA_VALUE_050 = [WORD_LEGACY_ADMIN_SYSTEM_SETTINGS, "_", WORD_SITE_NAME, "_not_empty"];
