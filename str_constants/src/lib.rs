...
str_constants_macros::define_str_constants! {
    ...
    constants {
        ...
        pub SERVER_ADMIN_ENABLE_MFA_SQL = [WORD_UPDATE, " ", WORD_ADMIN_USER_MFA, " ", WORD_SET, " ", WORD_ENABLED_AT, " = ", WORD_NOW_2, "(), ", WORD_UPDATED_AT, " = ", WORD_NOW_2, "() ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_ENABLED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_RETURNING, " ", WORD_TRUE_2];
