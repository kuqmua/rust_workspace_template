...
str_constants_macros::define_str_constants! {
    fragments {
        ...
        WORD_ADMIN_DEFAULT_MAIN_LOGO_SQL = "'https://example.com/admin-logo.svg'";
        WORD_ADMIN_DEFAULT_ORGANIZATION_CONTACTS_SQL = "'support@example.com'";
        WORD_ADMIN_DEFAULT_PRIMARY_COLOR_SQL = "'#5b55e7'";
        WORD_ADMIN_DEFAULT_SUPPORT_URL_SQL = "'https://example.com/support'";
        WORD_ADMIN_DEFAULT_TAB_TITLE_SQL = "'Admin'";
...
"#];
        ...
        pub SERVER_ADMIN_FRONTEND_SRC_APP_ROLES_CREATE_RS = [WORD_SERVER_ADMIN_FRONTEND, "/", WORD_SRC, "/", WORD_APP, "/roles/create.", WORD_RS];
        ...
        pub SERVER_ADMIN_FRONTEND_SRC_APP_USERS_CREATE_RS = [WORD_SERVER_ADMIN_FRONTEND, "/", WORD_SRC, "/", WORD_APP, "/users/create.", WORD_RS];
        ...
        pub SERVER_ADMIN_FRONTEND_SRC_SHARED_TABLE_FILTERS_FORM_RS = [WORD_SERVER_ADMIN_FRONTEND, "/", WORD_SRC, "/", WORD_SHARED, "/table_filters/form.", WORD_RS];
        ...
        pub SERVER_ADMIN_FRONTEND_SRC_SSR_ROLES_CREATE_RS = [WORD_SERVER_ADMIN_FRONTEND, "/", WORD_SRC, "/ssr/roles/create.", WORD_RS];
        ...
        pub SERVER_ADMIN_FRONTEND_SRC_SSR_USERS_CREATE_RS = [WORD_SERVER_ADMIN_FRONTEND, "/", WORD_SRC, "/ssr/users/create.", WORD_RS];
        ...
        pub WRITE_ONLY = [WORD_WRITE_ONLY];
        ...
        pub SERVER_ADMIN_UPDATE_SETTINGS_SQL = [WORD_UPDATE, " ", WORD_ADMIN_SYSTEM_SETTINGS, " ", WORD_SET, " ", WORD_SITE_NAME, " = ", WORD_COALESCE, "($1, ", WORD_SITE_NAME, "), ", WORD_TAB_TITLE, " = CASE WHEN $9 THEN ", WORD_ADMIN_DEFAULT_TAB_TITLE_SQL, " ELSE ", WORD_COALESCE, "($2, ", WORD_TAB_TITLE, ") END, ", WORD_MAIN_LOGO, " = CASE WHEN $10 THEN ", WORD_ADMIN_DEFAULT_MAIN_LOGO_SQL, " ELSE ", WORD_COALESCE, "($3, ", WORD_MAIN_LOGO, ") END, ", WORD_PRIMARY_COLOR, " = CASE WHEN $11 THEN ", WORD_ADMIN_DEFAULT_PRIMARY_COLOR_SQL, " ELSE ", WORD_COALESCE, "($4, ", WORD_PRIMARY_COLOR, ") END, ", WORD_DEFAULT_ADMIN_ROUTE, " = ", WORD_COALESCE, "($5, ", WORD_DEFAULT_ADMIN_ROUTE, "), ", WORD_ORGANIZATION_NAME, " = CASE WHEN $12 THEN ", WORD_ADMIN_DEFAULT_TAB_TITLE_SQL, " ELSE ", WORD_COALESCE, "($6, ", WORD_ORGANIZATION_NAME, ") END, ", WORD_ORGANIZATION_CONTACTS, " = CASE WHEN $13 THEN ", WORD_ADMIN_DEFAULT_ORGANIZATION_CONTACTS_SQL, " ELSE ", WORD_COALESCE, "($7, ", WORD_ORGANIZATION_CONTACTS, ") END, ", WORD_SUPPORT_URL, " = CASE WHEN $14 THEN ", WORD_ADMIN_DEFAULT_SUPPORT_URL_SQL, " ELSE ", WORD_COALESCE, "($8, ", WORD_SUPPORT_URL, ") END ", WORD_WHERE, " ", WORD_ID, " = 1 ", WORD_RETURNING, " ", WORD_TRUE_2];
        ...
        pub SERVER_ADMIN_USER_ID_BY_LOGIN_SQL = [WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_WHERE, " ", WORD_LOWER, "(", WORD_LOGIN, ") = ", WORD_LOWER, "($1)"];
...
pub const CODE_STYLE_LEPTOS_PRELUDE_SUFFIXES: [&str; 60] = [
    ...
    SERVER_ADMIN_FRONTEND_SRC_APP_ROLES_CREATE_RS,
    ...
    SERVER_ADMIN_FRONTEND_SRC_APP_USERS_CREATE_RS,
    ...
    SERVER_ADMIN_FRONTEND_SRC_SHARED_TABLE_FILTERS_FORM_RS,
    "server_admin_frontend/src/shared/table_filters/form/sort.rs",
    ...
    SERVER_ADMIN_FRONTEND_SRC_SSR_ROLES_CREATE_RS,
    ...
    SERVER_ADMIN_FRONTEND_SRC_SSR_USERS_CREATE_RS,
...
pub const CODE_STYLE_LEPTOS_PRELUDE_REASONS: [&str; 60] = [
    ...
    "Leptos CSR role-creation component requires attribute traits in lexical scope",
    ...
    "Leptos CSR user-creation component requires attribute traits in lexical scope",
    ...
    "shared Leptos table-filter form requires attribute traits in lexical scope",
    "shared Leptos table sort selector requires attribute traits in lexical scope",
    ...
    "Leptos SSR role creation requires attribute traits in lexical scope",
    ...
    "Leptos SSR user creation requires attribute traits in lexical scope",
