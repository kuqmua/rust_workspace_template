str_constants_macros::define_str_constants! {
    ...
    constants {
        ...
        pub DELETE_FROM_ADMIN_ROLE_PERMISSIONS_WHERE_ROLE_ID_DOLLAR_1 = [WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_ROLE_PERMISSIONS, " ", WORD_WHERE, " ", WORD_ROLE_ID, " = $1"];
        pub DELETE_FROM_ADMIN_ROLES_WHERE_ID_DOLLAR_1_AND_IS_SYSTEM_FALSE = [WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_AND, " ", WORD_IS_SYSTEM, " = ", WORD_FALSE, " ", WORD_RETURNING, " ", WORD_TRUE];
        pub DELETE_FROM_ADMIN_USER_ROLES_WHERE_USER_ID_DOLLAR_1 = [WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_USER_ROLES, " ", WORD_WHERE, " ", WORD_USER_ID, " = $1"];
        pub DELETE_FROM_ADMIN_USERS_WHERE_ID_DOLLAR_1_RETURNING_TRUE = [WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_RETURNING, " ", WORD_TRUE];
        ...
        pub ID = ["ID"];
        pub INSERT_INTO_ADMIN_ACCESS_SESSIONS_ID_USER_ID_TOKEN_IDENTIFIER_HASH_TOKEN = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_ACCESS_SESSIONS, " (", WORD_ID, ", ", WORD_USER_ID, ", token_identifier_hash, ", WORD_TOKEN_CONTEXT_HASH, ", ", WORD_CSRF_TOKEN_HASH, ", ", WORD_EXPIRES_AT, ") ", WORD_VALUES, " ($1, $2, $3, $4, $5, ", WORD_NOW, "() + ($6 * ", WORD_INTERVAL, " \'1 ", WORD_SECOND, "\'))"];
        ...
        pub INSERT_INTO_ADMIN_AUDIT_LOG_USER_ID_USER_LOGIN_ACTION_RESOURCE_RESOURCE = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_AUDIT_LOG, " (", WORD_USER_ID, ", ", WORD_USER_LOGIN, ", ", WORD_ACTION, ", ", WORD_RESOURCE, ", ", WORD_RESOURCE_ID, ", ", WORD_REQUEST_ID, ", ", WORD_SUCCEEDED, ", ", WORD_DETAILS, ") ", WORD_VALUES, " ($1, $2, $3, $4, $5, $6, ", WORD_TRUE, ", $7)"];
        ...
        pub INSERT_INTO_ADMIN_RATE_LIMITS_SCOPE_SUBJECT_WINDOW_STARTED_AT_REQUEST_COUNT = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_RATE_LIMITS, " (", WORD_SCOPE, ", ", WORD_SUBJECT, ", ", WORD_WINDOW_STARTED_AT, ", ", WORD_REQUEST_COUNT, ") ", WORD_VALUES, " ($1, $2, ", WORD_NOW, "(), 1) ", WORD_ON, " ", WORD_CONFLICT, " (", WORD_SCOPE, ", ", WORD_SUBJECT, ") ", WORD_DO, " ", WORD_UPDATE, " ", WORD_SET, " ", WORD_WINDOW_STARTED_AT, " = ", WORD_CASE, " ", WORD_WHEN, " ", WORD_ADMIN_RATE_LIMITS, ".", WORD_WINDOW_STARTED_AT, " <= ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $4) ", WORD_THEN, " ", WORD_NOW, "() ", WORD_ELSE, " ", WORD_ADMIN_RATE_LIMITS, ".", WORD_WINDOW_STARTED_AT, " ", WORD_END, ", ", WORD_REQUEST_COUNT, " = ", WORD_CASE, " ", WORD_WHEN, " ", WORD_ADMIN_RATE_LIMITS, ".", WORD_WINDOW_STARTED_AT, " <= ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $4) ", WORD_THEN, " 1 ", WORD_ELSE, " ", WORD_ADMIN_RATE_LIMITS, ".", WORD_REQUEST_COUNT, " + 1 ", WORD_END, " ", WORD_RETURNING, " ", WORD_REQUEST_COUNT, " <= $3"];
        ...
        pub INSERT_INTO_ADMIN_REFRESH_TOKENS_ID_USER_ID_TOKEN_HASH_EXPIRES_AT = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_REFRESH_TOKENS, " (", WORD_ID, ", ", WORD_USER_ID, ", ", WORD_TOKEN_HASH, ", ", WORD_EXPIRES_AT, ") ", WORD_VALUES, " ($1, $2, $3, ", WORD_NOW, "() + ($4 * ", WORD_INTERVAL, " \'1 ", WORD_SECOND, "\'))"];
        pub INSERT_INTO_ADMIN_ROLE_PERMISSIONS_ROLE_ID_PERMISSION_ID_SELECT_DOLLAR_1 = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_ROLE_PERMISSIONS, " (", WORD_ROLE_ID, ", ", WORD_PERMISSION_ID, ") ", WORD_SELECT, " $1, ", WORD_PERMISSION_ID, " ", WORD_FROM, " ", WORD_UNNEST, "($2::", WORD_BIGINT, "[]) ", WORD_AS, " ", WORD_PERMISSION_ID];
        pub INSERT_INTO_ADMIN_ROLES_NAME_IS_SYSTEM_VALUES_DOLLAR_1_FALSE_RETURNING = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_ROLES, " (", WORD_NAME_2, ", ", WORD_IS_SYSTEM, ") ", WORD_VALUES, " ($1, ", WORD_FALSE, ") ", WORD_RETURNING, " ", WORD_ID];
        pub INSERT_INTO_ADMIN_USER_ROLES_USER_ID_ROLE_ID_SELECT_DOLLAR_1 = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_USER_ROLES, " (", WORD_USER_ID, ", ", WORD_ROLE_ID, ") ", WORD_SELECT, " $1, ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_WHERE, " ", WORD_NAME_2, " = \'", WORD_ADMIN_2, "\'"];
        pub INSERT_INTO_ADMIN_USER_ROLES_USER_ID_ROLE_ID_SELECT_DOLLAR_1_ALT = [WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_USER_ROLES, " (", WORD_USER_ID, ", ", WORD_ROLE_ID, ") ", WORD_SELECT, " $1, ", WORD_ROLE_ID, " ", WORD_FROM, " ", WORD_UNNEST, "($2::", WORD_BIGINT, "[]) ", WORD_AS, " ", WORD_ROLE_ID];
        ...
        pub LOCK_TABLE_ADMIN_USERS_IN_EXCLUSIVE_MODE = ["LOCK ", WORD_TABLE, " ", WORD_ADMIN_USERS, " ", WORD_IN, " EXCLUSIVE MODE"];
        ...
        pub SELECT_COUNT_ASTERISK_FROM_ADMIN_LOGIN_ATTEMPTS_WHERE_LOGIN_DOLLAR_1_AND = [WORD_SELECT, " ", WORD_COUNT, "(*) ", WORD_FROM, " ", WORD_ADMIN_LOGIN_ATTEMPTS, " ", WORD_WHERE, " ", WORD_LOGIN, " = $1 ", WORD_AND, " ", WORD_SUCCEEDED, " = ", WORD_FALSE, " ", WORD_AND, " ", WORD_ATTEMPTED_AT, " > ", WORD_NOW, "() - ", WORD_INTERVAL, " \'15 ", WORD_MINUTES, "\'"];
        pub SELECT_COUNT_ASTERISK_FROM_ADMIN_PERMISSIONS_WHERE_ID_ANY_DOLLAR_1 = [WORD_SELECT, " ", WORD_COUNT, "(*) ", WORD_FROM, " ", WORD_ADMIN_PERMISSIONS, " ", WORD_WHERE, " ", WORD_ID, " = ", WORD_ANY, "($1)"];
        ...
        pub SELECT_COUNT_ASTERISK_FROM_ADMIN_ROLES_WHERE_ID_ANY_DOLLAR_1 = [WORD_SELECT, " ", WORD_COUNT, "(*) ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_WHERE, " ", WORD_ID, " = ", WORD_ANY, "($1)"];
        ...
        pub SELECT_COUNT_DISTINCT_USERS_ID_FROM_ADMIN_USERS_USERS_JOIN_ADMIN_USER = [WORD_SELECT, " ", WORD_COUNT, "(", WORD_DISTINCT, " ", WORD_USERS_2, ".", WORD_ID, ") ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_USERS_2, " ", WORD_JOIN, " ", WORD_ADMIN_USER_ROLES, " ", WORD_USER_ROLE, " ", WORD_ON, " ", WORD_USER_ROLE, ".", WORD_USER_ID, " = ", WORD_USERS_2, ".", WORD_ID, " ", WORD_WHERE, " ", WORD_USER_ROLE, ".", WORD_ROLE_ID, " = $1 ", WORD_AND, " ", WORD_USERS_2, ".", WORD_IS_BANNED, " = ", WORD_FALSE];
        pub SELECT_DISTINCT_PERMISSION_NAME_FROM_ADMIN_PERMISSIONS_PERMISSION_JOIN_ADMIN_ROLE_PERMISSIONS = [WORD_SELECT, " ", WORD_DISTINCT, " ", WORD_PERMISSION, ".", WORD_NAME_2, " ", WORD_FROM, " ", WORD_ADMIN_PERMISSIONS, " ", WORD_PERMISSION, " ", WORD_JOIN, " ", WORD_ADMIN_ROLE_PERMISSIONS, " ", WORD_ROLE_PERMISSION, " ", WORD_ON, " ", WORD_ROLE_PERMISSION, ".", WORD_PERMISSION_ID, " = ", WORD_PERMISSION, ".", WORD_ID, " ", WORD_JOIN, " ", WORD_ADMIN_USER_ROLES, " ", WORD_USER_ROLE, " ", WORD_ON, " ", WORD_USER_ROLE, ".", WORD_ROLE_ID, " = ", WORD_ROLE_PERMISSION, ".", WORD_ROLE_ID, " ", WORD_WHERE, " ", WORD_USER_ROLE, ".", WORD_USER_ID, " = $1 ", WORD_ORDER, " ", WORD_BY, " ", WORD_PERMISSION, ".", WORD_NAME_2];
        pub SELECT_EXISTS_SELECT_1_FROM_ADMIN_ACCESS_SESSIONS_SESSION_JOIN_ADMIN_USERS = [WORD_SELECT, " ", WORD_EXISTS, " (", WORD_SELECT, " 1 ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_SESSION, " ", WORD_JOIN, " ", WORD_ADMIN_USERS, " ", WORD_USERS_2, " ", WORD_ON, " ", WORD_USERS_2, ".", WORD_ID, " = ", WORD_SESSION, ".", WORD_USER_ID, " ", WORD_WHERE, " ", WORD_SESSION, ".", WORD_ID, " = $1 ", WORD_AND, " ", WORD_SESSION, ".", WORD_USER_ID, " = $2 ", WORD_AND, " ", WORD_SESSION, ".", WORD_TOKEN_CONTEXT_HASH, " = $3 ", WORD_AND, " ", WORD_SESSION, ".", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_AND, " ", WORD_SESSION, ".", WORD_EXPIRES_AT, " > ", WORD_NOW, "() ", WORD_AND, " ", WORD_USERS_2, ".", WORD_IS_BANNED, " = ", WORD_FALSE, ")"];
        ...
        pub SELECT_ID_CREATED_AT_PATH_TEXT_EXPIRES_AT_PATH_TEXT_FROM_ADMIN = [WORD_SELECT, " ", WORD_ID, ", ", WORD_CREATED_AT, "::", WORD_TEXT, ", ", WORD_EXPIRES_AT, "::", WORD_TEXT, " ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_AND, " ", WORD_EXPIRES_AT, " > ", WORD_NOW, "() ", WORD_ORDER, " ", WORD_BY, " ", WORD_CREATED_AT, " ", WORD_DESC];
        pub SELECT_ID_LOGIN_DISPLAY_NAME_IS_BANNED_FROM_ADMIN_USERS_ORDER_BY = [WORD_SELECT, " ", WORD_ID, ", ", WORD_LOGIN, ", ", WORD_DISPLAY_NAME, ", ", WORD_IS_BANNED, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_ORDER, " ", WORD_BY, " ", WORD_LOGIN, " ", WORD_LIMIT, " 500"];
        pub SELECT_ID_NAME_FROM_ADMIN_PERMISSIONS_ORDER_BY_NAME = [WORD_SELECT, " ", WORD_ID, ", ", WORD_NAME_2, " ", WORD_FROM, " ", WORD_ADMIN_PERMISSIONS, " ", WORD_ORDER, " ", WORD_BY, " ", WORD_NAME_2];
        pub SELECT_ID_NAME_IS_SYSTEM_FROM_ADMIN_ROLES_ORDER_BY_NAME = [WORD_SELECT, " ", WORD_ID, ", ", WORD_NAME_2, ", ", WORD_IS_SYSTEM, " ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_ORDER, " ", WORD_BY, " ", WORD_NAME_2];
        pub SELECT_ID_PASSWORD_HASH_IS_BANNED_FROM_ADMIN_USERS_WHERE_LOWER_LOGIN = [WORD_SELECT, " ", WORD_ID, ", ", WORD_PASSWORD_HASH, ", ", WORD_IS_BANNED, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_WHERE, " ", WORD_LOWER, "(", WORD_LOGIN, ") = ", WORD_LOWER, "($1)"];
        pub SELECT_ID_USER_ID_USER_LOGIN_ACTION_RESOURCE_RESOURCE_ID_SUCCEEDED_DETAILS = [WORD_SELECT, " ", WORD_ID, ", ", WORD_USER_ID, ", ", WORD_USER_LOGIN, ", ", WORD_ACTION, ", ", WORD_RESOURCE, ", ", WORD_RESOURCE_ID, ", ", WORD_SUCCEEDED, ", ", WORD_DETAILS, ", ", WORD_CREATED_AT, "::", WORD_TEXT, " ", WORD_FROM, " ", WORD_ADMIN_AUDIT_LOG, " ", WORD_WHERE, " ($1::", WORD_BIGINT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_OR, " ", WORD_USER_ID, " = $1) ", WORD_AND, " ($2::", WORD_TEXT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_OR, " ", WORD_ACTION, " = $2) ", WORD_AND, " ($3::", WORD_TEXT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_OR, " ", WORD_RESOURCE, " = $3) ", WORD_AND, " ($4::", WORD_TIMESTAMPTZ, " ", WORD_IS, " ", WORD_NULL, " ", WORD_OR, " ", WORD_CREATED_AT, " >= $4::", WORD_TIMESTAMPTZ, ") ", WORD_AND, " ($5::", WORD_TIMESTAMPTZ, " ", WORD_IS, " ", WORD_NULL, " ", WORD_OR, " ", WORD_CREATED_AT, " <= $5::", WORD_TIMESTAMPTZ, ") ", WORD_ORDER, " ", WORD_BY, " ", WORD_CREATED_AT, " ", WORD_DESC, " ", WORD_LIMIT, " 200"];
        pub SELECT_IS_SYSTEM_FROM_ADMIN_ROLES_WHERE_ID_DOLLAR_1_FOR_UPDATE = [WORD_SELECT, " ", WORD_IS_SYSTEM, " ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_FOR, " ", WORD_UPDATE];
        pub SELECT_LOGIN_FROM_ADMIN_USERS_WHERE_ID_DOLLAR_1_AND_IS_BANNED = [WORD_SELECT, " ", WORD_LOGIN, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_AND, " ", WORD_IS_BANNED, " = ", WORD_FALSE];
        pub SELECT_LOGIN_DISPLAY_NAME_FROM_ADMIN_USERS_WHERE_ID_DOLLAR_1_AND = [WORD_SELECT, " ", WORD_LOGIN, ", ", WORD_DISPLAY_NAME, " ", WORD_FROM, " ", WORD_ADMIN_USERS, " ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_AND, " ", WORD_IS_BANNED, " = ", WORD_FALSE];
        ...
        pub SELECT_ROLE_NAME_FROM_ADMIN_ROLES_ROLE_JOIN_ADMIN_USER_ROLES_LINK = [WORD_SELECT, " ", WORD_ROLE, ".", WORD_NAME_2, " ", WORD_FROM, " ", WORD_ADMIN_ROLES, " ", WORD_ROLE, " ", WORD_JOIN, " ", WORD_ADMIN_USER_ROLES, " ", WORD_LINK, " ", WORD_ON, " ", WORD_LINK, ".", WORD_ROLE_ID, " = ", WORD_ROLE, ".", WORD_ID, " ", WORD_WHERE, " ", WORD_LINK, ".", WORD_USER_ID, " = $1 ", WORD_ORDER, " ", WORD_BY, " ", WORD_ROLE, ".", WORD_NAME_2];
        pub SELECT_SITE_NAME_TAB_TITLE_MAIN_LOGO_PRIMARY_COLOR_DEFAULT_ADMIN_ROUTE = [WORD_SELECT, " ", WORD_SITE_NAME, ", ", WORD_TAB_TITLE, ", ", WORD_MAIN_LOGO, ", ", WORD_PRIMARY_COLOR, ", ", WORD_DEFAULT_ADMIN_ROUTE, ", ", WORD_ORGANIZATION_NAME, ", ", WORD_ORGANIZATION_CONTACTS, ", ", WORD_SUPPORT_URL, " ", WORD_FROM, " ", WORD_ADMIN_SYSTEM_SETTINGS, " ", WORD_WHERE, " ", WORD_ID, " = 1"];
        ...
        pub SELECT_USER_ID_FROM_ADMIN_REFRESH_TOKENS_WHERE_TOKEN_HASH_DOLLAR_1 = [WORD_SELECT, " ", WORD_USER_ID, " ", WORD_FROM, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_WHERE, " ", WORD_TOKEN_HASH, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_AND, " ", WORD_EXPIRES_AT, " > ", WORD_NOW, "() ", WORD_FOR, " ", WORD_UPDATE];
        pub SET_LOCAL_APP_ADMIN_AUDIT_CLEANUP_ON = [WORD_SET, " LOCAL ", WORD_APP, ".admin_audit_cleanup = \'on\'"];
        pub SELF = [WORD_SELF];
        ...
        pub UPDATE_ADMIN_ACCESS_SESSIONS_SET_REVOKED_AT_NOW_WHERE_USER_ID_DOLLAR = [WORD_UPDATE, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_SET, " ", WORD_REVOKED_AT, " = ", WORD_NOW, "() ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_AND, " ", WORD_ID, " ", WORD_IN, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_ORDER, " ", WORD_BY, " ", WORD_CREATED_AT, " ", WORD_DESC, " ", WORD_OFFSET, " $2)"];
        pub UPDATE_ADMIN_REFRESH_TOKENS_SET_REVOKED_AT_NOW_WHERE_TOKEN_HASH_DOLLAR = [WORD_UPDATE, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_SET, " ", WORD_REVOKED_AT, " = ", WORD_NOW, "() ", WORD_WHERE, " ", WORD_TOKEN_HASH, " = $1 ", WORD_AND, " ", WORD_USER_ID, " = $2 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL];
        pub UPDATE_ADMIN_REFRESH_TOKENS_SET_REVOKED_AT_NOW_WHERE_USER_ID_DOLLAR = [WORD_UPDATE, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_SET, " ", WORD_REVOKED_AT, " = ", WORD_NOW, "() ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_AND, " ", WORD_ID, " ", WORD_IN, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_WHERE, " ", WORD_USER_ID, " = $1 ", WORD_AND, " ", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NULL, " ", WORD_ORDER, " ", WORD_BY, " ", WORD_CREATED_AT, " ", WORD_DESC, " ", WORD_OFFSET, " $2)"];
        pub UPDATE_ADMIN_ROLES_SET_NAME_DOLLAR_2_WHERE_ID_DOLLAR_1_AND = [WORD_UPDATE, " ", WORD_ADMIN_ROLES, " ", WORD_SET, " ", WORD_NAME_2, " = $2 ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_AND, " ", WORD_IS_SYSTEM, " = ", WORD_FALSE, " ", WORD_RETURNING, " ", WORD_TRUE];
        pub UPDATE_ADMIN_SYSTEM_SETTINGS_SET_SITE_NAME_COALESCE_DOLLAR_1_SITE_NAME = [WORD_UPDATE, " ", WORD_ADMIN_SYSTEM_SETTINGS, " ", WORD_SET, " ", WORD_SITE_NAME, " = ", WORD_COALESCE, "($1, ", WORD_SITE_NAME, "), ", WORD_TAB_TITLE, " = ", WORD_COALESCE, "($2, ", WORD_TAB_TITLE, "), ", WORD_MAIN_LOGO, " = ", WORD_COALESCE, "($3, ", WORD_MAIN_LOGO, "), ", WORD_PRIMARY_COLOR, " = ", WORD_COALESCE, "($4, ", WORD_PRIMARY_COLOR, "), ", WORD_DEFAULT_ADMIN_ROUTE, " = ", WORD_COALESCE, "($5, ", WORD_DEFAULT_ADMIN_ROUTE, "), ", WORD_ORGANIZATION_NAME, " = ", WORD_COALESCE, "($6, ", WORD_ORGANIZATION_NAME, "), ", WORD_ORGANIZATION_CONTACTS, " = ", WORD_COALESCE, "($7, ", WORD_ORGANIZATION_CONTACTS, "), ", WORD_SUPPORT_URL, " = ", WORD_COALESCE, "($8, ", WORD_SUPPORT_URL, ") ", WORD_WHERE, " ", WORD_ID, " = 1 ", WORD_RETURNING, " ", WORD_TRUE];
        pub UPDATE_ADMIN_USERS_SET_IS_BANNED_DOLLAR_2_WHERE_ID_DOLLAR_1 = [WORD_UPDATE, " ", WORD_ADMIN_USERS, " ", WORD_SET, " ", WORD_IS_BANNED, " = $2 ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_RETURNING, " ", WORD_TRUE];
        pub UPDATE_ADMIN_USERS_SET_LOGIN_COALESCE_DOLLAR_2_LOGIN_DISPLAY_NAME_COALESCE = [WORD_UPDATE, " ", WORD_ADMIN_USERS, " ", WORD_SET, " ", WORD_LOGIN, " = ", WORD_COALESCE, "($2, ", WORD_LOGIN, "), ", WORD_DISPLAY_NAME, " = ", WORD_COALESCE, "($3, ", WORD_DISPLAY_NAME, ") ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_RETURNING, " ", WORD_TRUE];
        pub UPDATE_ADMIN_USERS_SET_PASSWORD_HASH_DOLLAR_2_WHERE_ID_DOLLAR_1 = [WORD_UPDATE, " ", WORD_ADMIN_USERS, " ", WORD_SET, " ", WORD_PASSWORD_HASH, " = $2 ", WORD_WHERE, " ", WORD_ID, " = $1 ", WORD_RETURNING, " ", WORD_TRUE];
        ...
        pub WITH_ATTEMPT_AS_INSERT_INTO_ADMIN_LOGIN_ATTEMPTS_LOGIN_IP_ADDRESS_SUCCEEDED = [WORD_WITH, " attempt ", WORD_AS, " (", WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_LOGIN_ATTEMPTS, " (", WORD_LOGIN, ", ", WORD_IP_ADDRESS, ", ", WORD_SUCCEEDED, ") ", WORD_VALUES, " ($1, $2, $3)) ", WORD_INSERT, " ", WORD_INTO, " ", WORD_ADMIN_AUDIT_LOG, " (", WORD_USER_LOGIN, ", ", WORD_ACTION, ", ", WORD_RESOURCE, ", ", WORD_RESOURCE_ID, ", ", WORD_REQUEST_ID, ", ", WORD_SUCCEEDED, ", ", WORD_DETAILS, ") ", WORD_SELECT, " $1, \'", WORD_SIGN_IN, "\', \'", WORD_SESSION, "\', $1, $4, ", WORD_FALSE, ", jsonb_build_object(\'", WORD_IP_ADDRESS, "\', $2::INET::", WORD_TEXT, ") ", WORD_WHERE, " $3 = ", WORD_FALSE];
        ...
        pub WITH_EXPIRED_AS_SELECT_ID_FROM_ADMIN_ACCESS_SESSIONS_WHERE_EXPIRES_AT = [WORD_WITH, " ", WORD_EXPIRED, " ", WORD_AS, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_WHERE, " ", WORD_EXPIRES_AT, " < ", WORD_NOW, "() ", WORD_OR, " (", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NOT, " ", WORD_NULL, " ", WORD_AND, " ", WORD_REVOKED_AT, " < ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $1)) ", WORD_ORDER, " ", WORD_BY, " ", WORD_EXPIRES_AT, " ", WORD_LIMIT, " $2) ", WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ", WORD_TARGET, " ", WORD_USING, " ", WORD_EXPIRED, " ", WORD_WHERE, " ", WORD_TARGET, ".", WORD_ID, "=", WORD_EXPIRED, ".", WORD_ID];
        pub WITH_EXPIRED_AS_SELECT_ID_FROM_ADMIN_AUDIT_LOG_WHERE_CREATED_AT = [WORD_WITH, " ", WORD_EXPIRED, " ", WORD_AS, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_AUDIT_LOG, " ", WORD_WHERE, " ", WORD_CREATED_AT, " < ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $1) ", WORD_ORDER, " ", WORD_BY, " ", WORD_CREATED_AT, " ", WORD_LIMIT, " $2) ", WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_AUDIT_LOG, " ", WORD_TARGET, " ", WORD_USING, " ", WORD_EXPIRED, " ", WORD_WHERE, " ", WORD_TARGET, ".", WORD_ID, "=", WORD_EXPIRED, ".", WORD_ID];
        pub WITH_EXPIRED_AS_SELECT_ID_FROM_ADMIN_LOGIN_ATTEMPTS_WHERE_ATTEMPTED_AT = [WORD_WITH, " ", WORD_EXPIRED, " ", WORD_AS, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_LOGIN_ATTEMPTS, " ", WORD_WHERE, " ", WORD_ATTEMPTED_AT, " < ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $1) ", WORD_ORDER, " ", WORD_BY, " ", WORD_ATTEMPTED_AT, " ", WORD_LIMIT, " $2) ", WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_LOGIN_ATTEMPTS, " ", WORD_TARGET, " ", WORD_USING, " ", WORD_EXPIRED, " ", WORD_WHERE, " ", WORD_TARGET, ".", WORD_ID, "=", WORD_EXPIRED, ".", WORD_ID];
        pub WITH_EXPIRED_AS_SELECT_ID_FROM_ADMIN_REFRESH_TOKENS_WHERE_EXPIRES_AT = [WORD_WITH, " ", WORD_EXPIRED, " ", WORD_AS, " (", WORD_SELECT, " ", WORD_ID, " ", WORD_FROM, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_WHERE, " ", WORD_EXPIRES_AT, " < ", WORD_NOW, "() ", WORD_OR, " (", WORD_REVOKED_AT, " ", WORD_IS, " ", WORD_NOT, " ", WORD_NULL, " ", WORD_AND, " ", WORD_REVOKED_AT, " < ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $1)) ", WORD_ORDER, " ", WORD_BY, " ", WORD_EXPIRES_AT, " ", WORD_LIMIT, " $2) ", WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_REFRESH_TOKENS, " ", WORD_TARGET, " ", WORD_USING, " ", WORD_EXPIRED, " ", WORD_WHERE, " ", WORD_TARGET, ".", WORD_ID, "=", WORD_EXPIRED, ".", WORD_ID];
        pub WITH_EXPIRED_AS_SELECT_SCOPE_SUBJECT_FROM_ADMIN_RATE_LIMITS_WHERE_WINDOW = [WORD_WITH, " ", WORD_EXPIRED, " ", WORD_AS, " (", WORD_SELECT, " ", WORD_SCOPE, ",", WORD_SUBJECT, " ", WORD_FROM, " ", WORD_ADMIN_RATE_LIMITS, " ", WORD_WHERE, " ", WORD_WINDOW_STARTED_AT, " < ", WORD_NOW, "() - ", WORD_MAKE_INTERVAL, "(", WORD_SECS, " => $1) ", WORD_ORDER, " ", WORD_BY, " ", WORD_WINDOW_STARTED_AT, " ", WORD_LIMIT, " $2) ", WORD_DELETE, " ", WORD_FROM, " ", WORD_ADMIN_RATE_LIMITS, " ", WORD_TARGET, " ", WORD_USING, " ", WORD_EXPIRED, " ", WORD_WHERE, " ", WORD_TARGET, ".", WORD_SCOPE, "=", WORD_EXPIRED, ".", WORD_SCOPE, " ", WORD_AND, " ", WORD_TARGET, ".", WORD_SUBJECT, "=", WORD_EXPIRED, ".", WORD_SUBJECT];
