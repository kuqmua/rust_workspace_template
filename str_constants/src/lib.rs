...
str_constants_macros::define_str_constants! {
    ...
    constants {
        ...
        pub SERVER_ADMIN_DATA_ACCESS_SESSIONS_SQL = [WORD_SELECT, " ARRAY[id::text, user_id::text, expires_at::text, created_at::text, revoked_at::text] ", WORD_FROM, " ", WORD_ADMIN_ACCESS_SESSIONS, " ORDER BY created_at DESC, id DESC LIMIT $1 OFFSET $2"];
...
pub const ADMIN_DATABASE_ERROR_CODE: &str = "admin_database";
pub const ADMIN_HEADER_ERROR_CODE: &str = "admin_response_header";
pub const ADMIN_PASSWORD_HASH_ERROR_CODE: &str = "admin_password_hash";
pub const ADMIN_SESSION_ERROR_CODE: &str = "admin_session";
