...
pub mod macro_clippy {
    ...
    pub const CARGO_TEST_LIB_ARGS: [&str; 2] = [crate::TEST_ALT_3, crate::shared_values::LIB];
}
...
pub mod admin_table {
    pub const USER_SORTS: [(&str, &str); 4] = [
        (crate::LOGIN, crate::shared_values::LOGIN_2),
        (crate::DISPLAY_NAME, crate::shared_values::DISPLAY_NAME_2),
        (crate::sql_names::ID, crate::ID),
        (crate::STATUS_ALT, crate::shared_values::STATUS_2),
    ];
    pub const ROLE_SORTS: [(&str, &str); 3] = [
        (crate::NAME, crate::shared_values::NAME_2),
        (crate::sql_names::ID, crate::ID),
        (crate::SYSTEM, crate::shared_values::SYSTEM_2),
    ];
    ...
    pub const AUDIT_SORTS: [(&str, &str); 5] = [
        (crate::CREATED_AT, crate::shared_values::TIME),
        (crate::USER_ID, crate::shared_values::USER),
        (crate::ACTION, crate::shared_values::ACTION_2),
        (crate::RESOURCE, crate::shared_values::RESOURCE_2),
        (crate::SUCCEEDED, crate::RESULT),
    ];
}
