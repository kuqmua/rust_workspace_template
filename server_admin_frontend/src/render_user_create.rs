    ...
    super::crud_render_shell::crud_render_shell(
        ...
        leptos::view! {
            ...
            <crate::admin_card::AdminCard><form class="crud-form" method="post" action=server_admin_contract::admin_html_action::AdminHtmlAction::UserCreate.get()>
                ...
                <crate::admin_field::AdminField label="Display name"><crate::admin_input::AdminInput name="display_name" required=true /></crate::admin_field::AdminField>
                <crate::admin_field::AdminField label="Initial password"><crate::admin_input::AdminInput name="password" kind=crate::admin_input_kind::AdminInputKind::Password autocomplete="new-password" required=true /></crate::admin_field::AdminField>
