...
fn csrf_token() -> Result<AdminCsrfToken, crate::domain_types::app::state::AdminTableLoadError> {
...
pub(in crate::domain_types::app) async fn send_json<RequestBody>(
    method: crate::domain_types::app::mutation::AdminMutationMethod,
    path: &super::url::AdminCsrApiUrl,
    request_body: &RequestBody,
) -> Result<(), crate::domain_types::app::state::AdminTableLoadError>
where
    RequestBody: serde::Serialize,
{
    ...
    let response = wasm_bindgen::JsCast::dyn_into::<web_sys::Response>(response_value)
        .map_err(|_error| crate::domain_types::app::state::AdminTableLoadError::Response)?;
    response.ok().then_some(()).ok_or_else(|| {
        crate::domain_types::app::state::AdminTableLoadError::Http(
