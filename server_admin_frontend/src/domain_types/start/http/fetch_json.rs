...
) -> Result<Response, crate::domain_types::start::state::AdminTableLoadError>
where
    Response: serde::de::DeserializeOwned,
{
    let window =
        web_sys::window().ok_or(crate::domain_types::start::state::AdminTableLoadError::Fetch)?;
    ...
    let text = text_value
        .as_string()
        .ok_or(crate::domain_types::start::state::AdminTableLoadError::Response)?;
