...
pub(in crate::domain_types::start) fn AdminNav(
    ...
    leptos::view! {
        <header class="topbar"><crate::domain_types::with_owner::navigation::AdminSidebar>
            {admin.as_ref().map_or_else(Vec::new, |admin| server_admin_contract::domain_types::AdminDataTable::PG_ORDER.into_iter().filter(|table| {
                    ...
                    leptos::view! { <crate::domain_types::with_owner::navigation::AdminSidebarItem><crate::domain_types::with_owner::navigation::AdminNavigationLink active=active_table == Some(table) href=href>{name}</crate::domain_types::with_owner::navigation::AdminNavigationLink></crate::domain_types::with_owner::navigation::AdminSidebarItem> }
                }).collect::<Vec<_>>())}
            {admin.as_ref().map_or_else(Vec::new, |admin| server_admin_contract::domain_types::AdminPage::navigation().filter(|page| {
                    ...
                    leptos::view! { <crate::domain_types::with_owner::navigation::AdminSidebarItem><crate::domain_types::with_owner::navigation::AdminNavigationLink active=active href=href>{label}</crate::domain_types::with_owner::navigation::AdminNavigationLink></crate::domain_types::with_owner::navigation::AdminSidebarItem> }
                }).collect::<Vec<_>>())}
            <crate::domain_types::with_owner::navigation::AdminSidebarItem><form on:submit=move |event| {
        ...
        </crate::domain_types::with_owner::navigation::AdminSidebar></header>
    }
}
