    ...
    crate::domain_types::ui::with_owner(move || {
        leptos::view! {
            <singlestage::Dialog alert=true id=id class="w-full max-w-lg rounded-2xl border bg-background p-6 shadow-lg" dialog_trigger=singlestage::DialogTrigger::builder().children(leptos::prelude::ToChildren::to_children(move || leptos::view! {
                <crate::domain_types::ui::button::AdminButton variant=crate::domain_types::ui::button::AdminButtonVariant::Danger kind=crate::domain_types::ui::button::AdminButtonKind::Button disabled=disabled>{trigger}</crate::domain_types::ui::button::AdminButton>
            })).build()>
            <singlestage::DialogContent attr:data-name="AlertDialogContent" class="flex flex-col gap-4">
                <div data-name="AlertDialogBody" class="contents">
                    ...
                    <singlestage::DialogFooter attr:data-name="AlertDialogFooter" class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                        ...
                        <crate::domain_types::ui::button::AdminButton variant=crate::domain_types::ui::button::AdminButtonVariant::Danger on_click=leptos::prelude::Callback::new(move |_event| on_confirm.run(()))>{confirm}</crate::domain_types::ui::button::AdminButton>
