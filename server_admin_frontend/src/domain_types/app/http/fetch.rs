...
pub(in crate::domain_types::app) async fn fetch_json<Response>(
    url: &super::url::AdminCsrApiUrl,
) -> Result<Response, crate::domain_types::app::state::AdminTableLoadError>
where
    Response: serde::de::DeserializeOwned,
{
    ...
    if !response.ok() {
        return Err(crate::domain_types::app::state::AdminTableLoadError::Http(
    ...
    let text = text_value
        .as_string()
        .ok_or(crate::domain_types::app::state::AdminTableLoadError::Response)?;
