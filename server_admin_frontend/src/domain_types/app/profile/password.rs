...
pub(super) fn admin_change_password() -> impl leptos::prelude::IntoView {
    ...
    leptos::view! {
        <crate::domain_types::ui::card::AdminCard variant=crate::domain_types::ui::card::AdminCardVariant::Security>
            <crate::domain_types::ui::card::AdminCardHeader><crate::domain_types::ui::card::AdminCardTitle>"Change password"</crate::domain_types::ui::card::AdminCardTitle></crate::domain_types::ui::card::AdminCardHeader>
            <form novalidate on:submit=move |event| {
                ...
                if let (Ok(current), Ok(new_value), Ok(path)) = (
                    request.0,
                    request.1,
                    crate::domain_types::app::http::url::admin_api_url(
                        server_admin_contract::domain_types::AdminRoute::ChangeOwnPassword,
                    ),
                ) {
                    leptos::prelude::Set::set(&password_validation_failed, false);
                    crate::domain_types::app::mutation::reload_after(
                        crate::domain_types::app::mutation::AdminMutationMethod::Post,
                        path,
                ...
                <crate::domain_types::ui::field::AdminField label="Current password"><crate::domain_types::ui::input::AdminInput name="current_password" kind=crate::domain_types::ui::input::AdminInputKind::Password required=true bind_value=current_password /></crate::domain_types::ui::field::AdminField>
                <crate::domain_types::ui::field::AdminField label="New password">
                    <crate::domain_types::ui::input::AdminInput name="new_password" kind=crate::domain_types::ui::input::AdminInputKind::Password minlength=server_admin_contract::domain_types::ADMIN_NEW_PASSWORD_MIN_CHARS maxlength=server_admin_contract::domain_types::ADMIN_PASSWORD_MAX_CHARS required=true bind_value=new_password />
