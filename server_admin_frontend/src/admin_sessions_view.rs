    ...
    let rows = page.items().iter().map(|item| {
        ...
        leptos::view! {
            <crate::domain_types::with_owner::table::table_row::TableRow>
                ...
                }) /></div></crate::domain_types::with_owner::table::table_cell::TableCell>
            </crate::domain_types::with_owner::table::table_row::TableRow>
        }
    }).collect::<Vec<_>>();
    leptos::view! {
