...
fn editable_settings_render_every_input_kind_from_the_contract_catalog() {
    let settings = server_admin_contract::admin_settings_view::AdminSettingsView::new(
        server_admin_contract::admin_default_route::AdminDefaultRoute::try_from(String::from(constants_str::test_fixtures::VALUE_074B6E5E))
        ...
        Some(
            server_admin_contract::admin_main_logo::AdminMainLogo::try_from(String::from(
                constants_str::test_fixtures::VALUE_A24910BB,
            ))
        ...
        Some(
            server_admin_contract::admin_organization_contacts::AdminOrganizationContacts::try_from(String::from(
                constants_str::test_fixtures::VALUE_6F4C18D3,
            ))
            .expect("32da6e91 editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ),
        Some(
            server_admin_contract::admin_organization_name::AdminOrganizationName::try_from(String::from(constants_str::test_fixtures::VALUE_D029F87E))
                .expect("f4c739a1 editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ),
        Some(
            server_admin_contract::admin_primary_color::AdminPrimaryColor::try_from(String::from(constants_str::test_fixtures::VALUE_55F98A52))
                .expect("c86b50d7 editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ),
        server_admin_contract::admin_site_name::AdminSiteName::try_from(String::from(constants_str::test_fixtures::VALUE_AD710C1F))
        ...
        Some(
            server_admin_contract::admin_support_url::AdminSupportUrl::try_from(String::from(
                constants_str::test_fixtures::VALUE_FE4E2333,
            ))
            .expect("195d8eca editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ),
        Some(
            server_admin_contract::admin_tab_title::AdminTabTitle::try_from(String::from(constants_str::test_fixtures::VALUE_46BB10C9))
                .expect("e317c4b8 editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ),
    );
    let admin = server_admin_contract::authenticated_admin::AuthenticatedAdmin::new(
        server_admin_contract::admin_display_name::AdminDisplayName::try_from(String::from(constants_str::catalog::ADMIN)).expect("6fa15bc0 editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        ...
        server_admin_contract::admin_login::AdminLogin::try_from(String::from(constants_str::catalog::ROOT)).expect("241b70ae editable_settings_render_every_input_kind_from_the_contract_catalog invariant must hold"),
        server_admin_contract::admin_permission_values::AdminPermissionValues::try_from(vec![
            ...
            .expect(constants_str::test_fixtures::VALUE_414056C4),
        ])
