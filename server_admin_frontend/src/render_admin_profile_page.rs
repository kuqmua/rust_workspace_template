...
pub fn render_admin_profile_page(
    ...
    let content_view = leptos::view! {
        ...
        <crate::admin_card::AdminCard variant=crate::admin_card_variant::AdminCardVariant::Security><form method="post" action=server_admin_contract::admin_html_action::AdminHtmlAction::ProfilePassword.get()>
            ...
            <crate::admin_field::AdminField label="New password"><crate::admin_input::AdminInput name="new_password" kind=crate::admin_input_kind::AdminInputKind::Password minlength=server_admin_contract::identity::ADMIN_NEW_PASSWORD_MIN_CHARS maxlength=server_admin_contract::identity::ADMIN_PASSWORD_MAX_CHARS required=true /><singlestage::FieldDescription attr:class="password-policy">{constants_str::test_fixtures::ADMIN_PASSWORD_POLICY_DESCRIPTION}</singlestage::FieldDescription></crate::admin_field::AdminField>
