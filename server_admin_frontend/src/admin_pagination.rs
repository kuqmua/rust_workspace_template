...
pub(crate) fn AdminPagination(
    action: server_admin_contract::admin_frontend_path::AdminFrontendPath,
    ...
    let page_size_query = crate::admin_table_query_hidden_inputs::admin_table_query_hidden_inputs(
        &query.search,
        &query.sort,
        &crate::admin_table_query_direction::AdminTableQueryDirection::Csr(query.direction.clone()),
        query.limit,
    );
    ...
    let next_query = crate::admin_table_query_hidden_inputs::admin_table_query_hidden_inputs(
        &query.search,
        &query.sort,
        &crate::admin_table_query_direction::AdminTableQueryDirection::Csr(query.direction),
        query.limit,
    );
    leptos::view! {
        <singlestage::Pagination attr:data-name="Pagination" attr:aria-label="Table pages" class="table-pagination mx-auto flex w-full items-center justify-center gap-2">
            ...
            <singlestage::PaginationItem class="contents"><form class="table-page-size" method="get" action=action.get()>
                ...
                <crate::admin_input_group::AdminInputGroup>
                    <crate::admin_field::AdminField label="Rows"><crate::admin_input::AdminInput name="limit" kind=crate::admin_input_kind::AdminInputKind::Number min=server_admin_contract::admin_page_limit::AdminPageLimit::MIN max=server_admin_contract::admin_page_limit::AdminPageLimit::MAX initial_value=limit /></crate::admin_field::AdminField>
