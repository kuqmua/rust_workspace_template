...
fn crud_pages_render_dedicated_forms_and_navigation() {
    ...
    let admin = server_admin_contract::AuthenticatedAdmin::new(
        server_admin_contract::AdminDisplayName::try_from(String::from("CRUD Admin"))
            .expect("ee23b99d"),
        server_admin_contract::AdminUserId::try_from(1i64).expect("f56d7f68"),
        server_admin_contract::AdminLogin::try_from(String::from("crud_admin")).expect("67827f9a"),
        server_admin_contract::AdminPermissionValues::try_from(permissions).expect("9a38c3da"),
        server_admin_contract::AdminRoleNames::try_from(Vec::new()).expect("3bbf55bf"),
    );
        ...
        server_admin_contract::AdminUserSummaries::try_from(vec![
            server_admin_contract::AdminUserSummary::new(
                server_admin_contract::AdminDisplayName::try_from(String::from("Managed User"))
                    .expect("6aedc5dd"),
                server_admin_contract::AdminUserId::try_from(2i64).expect("157804e9"),
                server_admin_contract::AdminBool::from(false),
                server_admin_contract::AdminLogin::try_from(String::from("managed_user"))
                    .expect("a533b9db"),
                server_admin_contract::AdminRoleIds::try_from(Vec::new()).expect("124e4f65"),
            ),
        ])
        .expect("53d4cc88"),
        server_admin_contract::AdminRoleSummaries::try_from(Vec::new()).expect("8de8dbde"),
    ...
    let roles = server_admin_contract::AdminRolesPage::new(
        server_admin_contract::AdminRoleSummaries::try_from(vec![
            server_admin_contract::AdminRoleSummary::new(
                server_admin_contract::AdminRoleId::try_from(3i64).expect("03214ad5"),
                server_admin_contract::AdminBool::from(false),
                server_admin_contract::AdminRoleName::try_from(String::from("managed_role"))
                    .expect("3db6d7a7"),
                server_admin_contract::AdminPermissionIds::try_from(Vec::new()).expect("4a6a7b5a"),
            ),
        ])
        .expect("5ffb690c"),
        server_admin_contract::AdminPermissionSummaries::try_from(Vec::new()).expect("b1a319f1"),
        server_admin_contract::AdminPageTotal::from(1u64),
    );
