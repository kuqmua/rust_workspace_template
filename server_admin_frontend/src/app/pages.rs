...
pub(super) fn Shell(
    ...
    let current_path = RwSignal::new(if initial_path == str_constants::admin_page_paths::ROOT {
        let target = nav
            .iter()
    ...
    view! {
        <div class="app-shell"><header class="topbar"><a class="brand" href=str_constants::admin_page_paths::ROOT><span class="brand-mark">"A"</span><span><strong>"Admin"</strong><small>"Control center"</small></span></a><nav aria-label="Admin sections">
