use leptos::prelude::*;
const USER_SORTS: [(&str, &str); 4] = [
    ("login", "Login"),
    ("display_name", "Display name"),
    ("id", "ID"),
    ("status", "Status"),
];
const ROLE_SORTS: [(&str, &str); 3] = [("name", "Name"), ("id", "ID"), ("system", "System")];
const PERMISSION_SORTS: [(&str, &str); 2] = [("name", "Name"), ("id", "ID")];
const AUDIT_SORTS: [(&str, &str); 5] = [
    ("created_at", "Time"),
    ("user_id", "User"),
    ("action", "Action"),
    ("resource", "Resource"),
...
pub(super) fn users_view(
    ...
    <TableTools state sort_options=&USER_SORTS />
