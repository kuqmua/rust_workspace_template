    ...
    leptos::view! {
        <nav class="table-pagination" aria-label="Table pages">
            <form method="get" action=action.get()>
                {crate::shared::table_filters::admin_table_query_hidden_inputs(&query.search, &query.sort, &crate::shared::table_filters::AdminTableQueryDirection::Csr(query.direction.clone()), query.limit)}
            ...
            <form method="get" action=action.get()>
                {crate::shared::table_filters::admin_table_query_hidden_inputs(&query.search, &query.sort, &crate::shared::table_filters::AdminTableQueryDirection::Csr(query.direction), query.limit)}
