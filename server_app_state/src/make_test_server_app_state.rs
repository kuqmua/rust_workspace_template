    ...
    crate::server_app_state::ServerAppState {
        ...
        config: server_config::config::Config {
            ...
            database_url: crate::test_env::test_env(
                config_lib::std_env_var_ok::StdEnvVarOk::try_from(
                    constants_str::catalog::TEST_VALUES_UNREACHABLE_DATABASE_URL.to_owned(),
                )
            ...
            admin_access_token_ttl_seconds: crate::test_env::test_env(
                config_lib::std_env_var_ok::StdEnvVarOk::try_from(
                    constants_str::catalog::VALUE_900.to_owned(),
                )
            ...
            admin_swagger_enabled: crate::test_env::test_env(
                config_lib::std_env_var_ok::StdEnvVarOk::try_from(constants_str::catalog::TRUE.to_owned())
            ...
            pg_pool_min_connections: crate::test_env::test_env(
                config_lib::std_env_var_ok::StdEnvVarOk::try_from(
                    constants_str::catalog::VALUE_0.to_owned(),
                )
            ...
            admin_cookie_secure: crate::test_env::test_env(
                config_lib::std_env_var_ok::StdEnvVarOk::try_from(constants_str::catalog::FALSE.to_owned())
