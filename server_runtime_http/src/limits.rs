#[path = "acquire_permit.rs"]
mod acquire_permit;
#[path = "acquire_permit_error.rs"]
mod acquire_permit_error;
#[path = "arc_tokio_semaphore.rs"]
mod arc_tokio_semaphore;
#[path = "permit_wait_timeout_duration.rs"]
mod permit_wait_timeout_duration;
#[path = "retry_after_secs.rs"]
mod retry_after_secs;
#[path = "retry_after_secs_non_zero_u64.rs"]
mod retry_after_secs_non_zero_u64;
#[path = "retry_after_secs_try_from_u64_error.rs"]
mod retry_after_secs_try_from_u64_error;
#[path = "semaphore_permit_count_non_zero_usize.rs"]
mod semaphore_permit_count_non_zero_usize;
#[path = "tokio_acquire_error.rs"]
mod tokio_acquire_error;
#[path = "tokio_owned_semaphore_permit.rs"]
