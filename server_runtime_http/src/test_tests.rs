...
async fn test_request_span_uses_remote_parent_and_server_kind() {
    ...
    let trusted_proxy_ranges = crate::trusted_proxy_ranges::TrustedProxyRanges::try_from(vec![
        crate::trusted_proxy_range::TrustedProxyRange::try_from(
            constants_str::VALUE_127_0_0_1_32.to_owned(),
        )
            ...
            axum::routing::get(async || {
                ...
                let _previous = response.extensions_mut().insert(
                    crate::http_error_telemetry::HttpErrorTelemetry::new(
                        crate::http_error_type::HttpErrorType::from(constants_str::VALUE_E4FA4A90),
                        crate::http_error_code::HttpErrorCode::from(constants_str::VALUE_69C4B56B),
                    ),
                );
                response
            }),
...
async fn test_http_boundary_emits_one_complete_error_event_only_for_server_errors() {
    ...
    let diagnostic = crate::http_error_diagnostic::HttpErrorDiagnostic::capture(
        crate::http_error_telemetry::HttpErrorTelemetry::new(
            crate::http_error_type::HttpErrorType::from(constants_str::VALUE_D623C83D),
            crate::http_error_code::HttpErrorCode::from(constants_str::VALUE_40832A7F),
        ),
...
#[test]
fn test_observed_client_preparation_injects_context_and_creates_child_span() {
    opentelemetry::global::set_text_map_propagator(
        opentelemetry_sdk::propagation::TraceContextPropagator::new(),
    );
    let exporter = opentelemetry_sdk::trace::InMemorySpanExporterBuilder::new().build();
