pub(super) trait SupportedGeoJsonTypeValidation {
    fn validate_supported_geo_json_types(&self) -> Result<(), super::GeoJsonValidationError>;
}
...
impl SupportedGeoJsonTypeValidation for serde_json::Value {
    fn validate_supported_geo_json_types(&self) -> Result<(), super::GeoJsonValidationError> {
        let object = self
            .as_object()
            .ok_or(super::GeoJsonValidationError::Document)?;
        ...
        match value_type {
            ...
            _ => Err(super::GeoJsonValidationError::UnsupportedGeometry),
        }
    }
}
