...
pub(crate) fn AdminProfileView(
    ...
    let admin_profile_account = || {
        ...
        leptos::view! {
                <crate::admin_field::AdminField admin_field_label=constants_str::ADMIN_UI_DISPLAY_NAME><span class="profile-account-value">{display_name}</span></crate::admin_field::AdminField>
                <crate::admin_field::AdminField admin_field_label=constants_str::ADMIN_UI_LOGIN><span class="profile-account-value">{login}</span></crate::admin_field::AdminField>
                <crate::admin_field::AdminField admin_field_label=constants_str::ADMIN_UI_ROLES><span class="profile-account-value">{roles}</span></crate::admin_field::AdminField>
                <crate::admin_field::AdminField admin_field_label=constants_str::ADMIN_UI_RULES><span class="profile-account-value">{rules}</span></crate::admin_field::AdminField>
        }
    };
