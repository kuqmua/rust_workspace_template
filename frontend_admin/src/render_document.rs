...
pub(crate) fn render_document(
    ...
    crate::admin_ssr_html::AdminSsrHtml::try_from(format!(
        "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>{admin_ssr_text}</title><link rel=\"stylesheet\" href=\"/admin/assets/style.css?v=20260906-42\"><link rel=\"stylesheet\" href=\"/admin/assets/rust-ui.css?v=20260906-38\"></head><body>{}</body></html>",
