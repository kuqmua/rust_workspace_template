...
pub enum DeriveOrImpl {
    Derive,
    Impl(macros_helpers::domain_types::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream),
}
    ...
    > for ProcMacro2GeneratedRustTokenStreamVec
{
    ...
    where
        T: IntoIterator<
            Item = macros_helpers::domain_types::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream,
        >,
    {
...
#[derive(optimal_memory_layout::OptimalMemoryLayout, Debug, Clone, Copy, newtype::FromInner)]
pub struct SynFieldRefs<'lt>(&'lt [macros_helpers::domain_types::field_data::SynField]);
...
impl IsNullable {
    ...
    pub fn maybe_optional_wrap(
        &self,
        ts: macros_helpers::domain_types::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream,
    ) -> macros_helpers::domain_types::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream {
        match &self {
            Self::False => ts,
    ...
    T: filters::PgFilter,
{
    ...
    let pg_type_tokens_where_token_stream = {
        let vrts_token_stream = variants.iter().map(|element| {
            ...
            let optional_type_token_stream: Option<macros_helpers::domain_types::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream> =
