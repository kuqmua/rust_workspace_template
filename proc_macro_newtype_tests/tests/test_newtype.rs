#![allow(
    ...
    reason = "this integration test exercises the split proc-macro facade crates rather than linking the shared implementation crate directly"
)]
...
mod tests {
    ...
    #[derive(
        ...
        PartialEq,
        Eq,
        proc_macro_newtype_as_ref::AsRef,
        proc_macro_newtype_borrow_owned::BorrowOwned,
        proc_macro_newtype_from_inner::FromInner,
    ...
    #[derive(
        ...
        Copy,
        proc_macro_newtype_as_ref_inner::AsRefInner,
        proc_macro_newtype_borrow_inner::BorrowInner,
        proc_macro_newtype_from_inner::FromInner,
    )]
