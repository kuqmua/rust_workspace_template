...
impl frontend_contract::TypedRoute for AuthenticatedRoute {
    ...
    fn metadata() -> frontend_contract::RouteMetadata { frontend_contract::RouteMetadata::new(frontend_contract::ContractStr::from(str_constants::POST), frontend_contract::ContractStr::from(str_constants::WRITE_ALT), frontend_contract::ContractStr::from(str_constants::WRITE)) }
}
fn main() {
