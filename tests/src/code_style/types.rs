...
#[derive(optml::Optml, Debug, Clone, Copy, Default, newtype::FromInner)]
...
#[derive(optml::Optml, Debug, Clone, newtype::AsRefStr)]
pub(super) struct SourceText(Box<str>);
#[derive(optml::Optml, Debug, Clone, Copy, thiserror::Error)]
#[error(
...
#[derive(optml::Optml, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, newtype::FromInner)]
pub(super) struct FunctionBodyHash(u64);
#[derive(
    optml::Optml, Debug, Clone, Copy, newtype::AsRefInner, newtype::DerefTarget, newtype::FromInner,
)]
pub(super) struct RegexRegexRef<'regex_lt>(&'regex_lt regex::Regex);
#[derive(
    optml::Optml, Debug, Default, newtype::DerefInner, newtype::FromInner, newtype::IntoInnerFrom,
)]
...
#[derive(
    optml::Optml, Debug, Clone, newtype::AsRefOwned, newtype::FromInner, newtype::IntoInnerFrom,
)]
...
#[derive(optml::Optml, Debug, Clone, newtype::FromInner, newtype::IntoInner)]
pub(super) struct TomlValue(toml::Value);
#[derive(optml::Optml, newtype::FromInner, newtype::IntoIterator)]
