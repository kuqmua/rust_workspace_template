...
Tests marked with **Exceptions** contain an explicit allowlist, reviewed inventory, snapshot, or exempt owner/path. Ordinary test-fixture and out-of-scope filtering is not marked.

## `code_style_advanced_policy` (21)

- [ ] `allocations_inside_loops_match_reviewed_inventory` — **Exceptions**
- [ ] `arc_lock_and_trait_object_usage_matches_reviewed_inventory` — **Exceptions**
- [ ] `architectural_boundaries_reject_upward_dependencies`
- [ ] `contract_public_api_matches_reviewed_snapshot` — **Exceptions**
- [ ] `from_vec_implementations_are_forbidden`
- [ ] `ignored_map_err_bindings_match_reviewed_inventory` — **Exceptions**
...
- [ ] `raw_vec_tuple_wrappers_match_reviewed_inventory` — **Exceptions**
...
- [ ] `select_sites_match_reviewed_cancellation_inventory` — **Exceptions**
- [ ] `spawn_lifecycle_policy_rejects_unconsumed_tasks`
- [ ] `struct_error_exceptions_match_reviewed_snapshot` — **Exceptions** (93 entries; reduced by 17)
- [ ] `usize_max_expression_visitor_skips_test_modules`
- [ ] `usize_max_usage_matches_reviewed_inventory` — **Exceptions**
...
## `code_style_domain_type_policy` (28)
...
- [ ] `proc_macro_helpers_are_checked_while_compiler_entrypoints_are_exempt` — **Exceptions**
...
- [ ] `check_if_workspace_cargo_toml_workspace_lints_rust_contains_all_rust_lints` — **Exceptions**
...
- [ ] `custom_type_names_are_unique_across_workspace` — **Exceptions**
...
- [ ] `large_module_exceptions_are_exact_and_still_needed` — **Exceptions**
...
- [ ] `production_modules_have_bounded_responsibility` — **Exceptions**
...
- [ ] `substantial_function_bodies_have_one_source_of_truth` — **Exceptions**
...
- [ ] `all_string_constants_are_declared_in_str_constants` — **Exceptions**
...
- [ ] `direct_environment_and_filesystem_access_stays_at_owned_boundaries` — **Exceptions**
- [ ] `direct_filesystem_owner_inventory_is_exact_justified_and_current` — **Exceptions**
...
- [ ] `every_workspace_struct_and_enum_derives_optimal_memory_layout` — **Exceptions**
- [ ] `expect_and_panic_messages_start_with_unique_diagnostic_ids` — **Exceptions**
...
- [ ] `new_runtime_structs_keep_fields_private` — **Exceptions**
...
- [ ] `process_static_state_matches_reviewed_inventory` — **Exceptions**
...
- [ ] `string_constant_policy_has_only_the_constants_crate_source_directory_exception` — **Exceptions**
...
- [ ] `struct_fields_do_not_use_restricted_visibility` — **Exceptions**
- [ ] `text_content_hygiene_policy_rejects_all_line_ending_violations`
- [ ] `tuple_newtypes_derive_borrow_instead_of_implementing_forwarding_borrow` — **Exceptions**
- [ ] `tuple_newtypes_derive_deref_inner_instead_of_implementing_forwarding_deref` — **Exceptions**
- [ ] `tuple_newtypes_derive_display_instead_of_implementing_forwarding_display` — **Exceptions**
- [ ] `tuple_newtypes_derive_from_inner_instead_of_implementing_passthrough_from` — **Exceptions**
- [ ] `tuple_newtypes_derive_into_inner_from_instead_of_implementing_passthrough_from` — **Exceptions**
- [ ] `tuple_newtypes_derive_into_iterator_instead_of_forwarding_into_iter` — **Exceptions**
- [ ] `tuple_newtypes_derive_not_inner_instead_of_implementing_not` — **Exceptions**
...
- [ ] `unit_tests_use_deterministic_time_and_randomness_patterns` — **Exceptions**
