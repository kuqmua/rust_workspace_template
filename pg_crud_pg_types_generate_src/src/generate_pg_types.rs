...
#[serde(try_from = "Vec<crate::pg_type::PgType>")]
pub(super) struct GeneratePgTypes(pub(super) Vec<crate::pg_type::PgType>);

impl TryFrom<Vec<crate::pg_type::PgType>> for GeneratePgTypes {
    type Error = crate::generate_pg_types_length_error::GeneratePgTypesLengthError;

    fn try_from(value: Vec<crate::pg_type::PgType>) -> Result<Self, Self::Error> {
