...
impl PgType {
    pub(super) fn pg_type_can_be_nullable(self) -> CanBeNullable {
        domain_types::sqlx::pg_type_can_be_nullable::pg_type_can_be_nullable(self.spec())
    }
    pub(super) fn spec(
        self,
    ) -> domain_types::pg_type_spec::PgTypeSpec<
        CanBeNullable,
        CanBePrimaryKey,
        FilterKind,
        PgSqlName,
    ...
    > {
        match self {
            Self::I16AsInt2 => domain_types::pg_type_spec::PgTypeSpec {
            ...
            Self::I32AsInt4 => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Number,
            ...
            Self::I64AsInt8 => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Number,
            ...
            Self::F32AsFloat4 => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Number,
            ...
            Self::F64AsFloat8 => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Number,
            ...
            Self::I16AsSmallSerialInitializationByPg => domain_types::pg_type_spec::PgTypeSpec {
            ...
            Self::I32AsSerialInitializationByPg => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::True,
                can_be_nullable: CanBeNullable::False,
                filter_kind: FilterKind::Number,
            ...
            Self::I64AsBigSerialInitializationByPg => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::True,
                can_be_nullable: CanBeNullable::False,
                filter_kind: FilterKind::Number,
            ...
            Self::SqlxPgTypesPgMoneyAsMoney => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::BoolAsBool => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::StringAsText => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::StdVecVecU8AsBytea => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::SqlxTypesChronoNaiveTimeAsTime => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::SqlxTypesTimeTimeAsTime => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Time,
                pg_name: PgSqlName::from(constants_str::PG_CRUD_PG_TIME),
            ...
            Self::SqlxPgTypesPgIntervalAsInterval => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::SqlxTypesChronoNaiveDateAsDate => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::SqlxTypesIpnetworkIpNetworkAsInet => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::IntervalOrInet,
            ...
            Self::SqlxPgTypesPgRangeI32AsInt4Range => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
            ...
            Self::SqlxPgTypesPgRangeI64AsInt8Range => domain_types::pg_type_spec::PgTypeSpec {
                can_be_primary_key: CanBePrimaryKey::False,
                can_be_nullable: CanBeNullable::True,
                filter_kind: FilterKind::Range,
