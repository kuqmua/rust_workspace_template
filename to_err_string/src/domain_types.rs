proc_macro_to_err_string_impl_to_err_string_with::impl_to_err_string_with!(i8, i16, i32, i64, i128, isize, u8, u16, u32, u64, u128, f32, f64, bool, char => |v| v.to_string());
#[cfg(not(target_arch = "wasm32"))]
proc_macro_to_err_string_impl_to_err_string_with::impl_to_err_string_with!(reqwest::header::HeaderMap, http_body::SizeHint => |v| format!("{v:#?}"));
proc_macro_to_err_string_impl_to_err_string_with::impl_to_err_string_with!(
    usize,
    std::io::Error,
    serde_json::Error
    => |v| v.to_string()
...
proc_macro_to_err_string_impl_to_err_string_as_ref_str::impl_to_err_string_as_ref_str!(
    String,
    str,
    std::borrow::Cow<'_, str>
);
proc_macro_to_err_string_impl_to_err_string_const::impl_to_err_string_const!(
