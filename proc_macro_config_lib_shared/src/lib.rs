...
pub fn impl_try_from_secret_url(
    token_stream: proc_macro2::TokenStream,
) -> proc_macro2::TokenStream {
    let parts = workspace_macro_helpers::split_top_level_commas::split_top_level_commas(
        workspace_macro_helpers::proc_macro2_macro_tokens::ProcMacro2MacroTokens::from_into(
    ...
    let error_name = quote::format_ident!("{error_name_text}");
    quote::quote! {
        #[derive(Debug, proc_macro_getters::Getters, proc_macro_generate_accessor_traits_for_struct_fields_generate_accessor_trait::GenerateAccessorTrait, proc_macro_optimal_memory_layout::OptimalMemoryLayout)]
...
pub fn impl_try_from_parse(token_stream: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
    proc_macro2::TokenStream::from(impl_try_from_parse_with_error_ty(
...
fn impl_try_from_parse_with_error_ty(
    ...
    proc_macro_try_from_parse_token_stream::ProcMacroTryFromParseTokenStream::from(
        proc_macro2::TokenStream::from(quote::quote! {
            #[derive(Debug, #(#derives,)* proc_macro_getters::Getters, proc_macro_generate_accessor_traits_for_struct_fields_generate_accessor_trait::GenerateAccessorTrait, proc_macro_optimal_memory_layout::OptimalMemoryLayout)]
