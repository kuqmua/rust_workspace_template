...
> Исторический снимок от 2026-07-17. Текущая административная панель использует серверный Leptos
> без Trunk, Playwright, JavaScript/TypeScript и клиентского WASM. Соответствующие упоминания ниже
> сохранены только как контекст исходного аудита и не являются инструкциями для текущей сборки.
