...
{
    crate::domain_types::ProcessCommands::from(bounded_types::BoundedVec::from_max_iter(
        specs
            .into_iter()
            .map(|spec| crate::domain_types::ProcessCommand {
                arguments: crate::domain_types::ProcessArguments::from(
                    bounded_types::BoundedVec::from_max_iter([
