...
export ADMIN_SESSION_LIMIT="8"
export ADMIN_SIGN_IN_RATE_LIMIT="10"
...
export CONTENT_SECURITY_POLICY="default-src 'self'; script-src 'self' 'wasm-unsafe-eval'; object-src 'none'; frame-ancestors 'none'"
