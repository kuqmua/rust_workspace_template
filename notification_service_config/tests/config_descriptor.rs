...
mod tests {
    fn descriptor_examples() -> std::collections::BTreeMap<String, String> {
        notification_service_config::domain_types::Config::env_example()
            .lines()
    ...
    fn env_example_matches_generated_descriptor() {
        ...
        let descriptors = notification_service_config::domain_types::Config::field_descriptors();
    ...
    fn compose_environment_keys_match_generated_descriptor() {
        ...
        let expected = notification_service_config::domain_types::Config::field_descriptors()
            .into_iter()
