#[proc_macro_frontend_contract_route_error::route_error(AdminAuditLogReadPageError)]
#[allow(
    clippy::single_call_fn,
    reason = "typed frontend route registration requires a named endpoint function"
)]
pub(crate) async fn audit_log_read_page(
    ...
    let _admin_audit_log_id = axum_admin_path.into_inner();
