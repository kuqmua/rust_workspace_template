...
#[frontend_contract::domain_types::route_openapi(delegate = super::roles::role_mutations_update::role_mutations_update, tag = "admin_roles")]
pub(super) async fn api_update_role(
