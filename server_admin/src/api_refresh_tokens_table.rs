...
pub(crate) async fn api_refresh_tokens_table(
    ...
    crate::application_auth::AdminRefreshTokensTableError,
> {
    ...
    .await
    .map_err(crate::application_auth::AdminRefreshTokensTableError::from)
}
