...
pub(crate) async fn api_role_permissions_table(
    ...
    crate::application_auth::AdminRolePermissionsTableError,
> {
    ...
    .await
    .map_err(crate::application_auth::AdminRolePermissionsTableError::from)
}
