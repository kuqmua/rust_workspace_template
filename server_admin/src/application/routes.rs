...
#[frontend_contract::domain_types::route_registry(
    ...
    (server_admin_contract::domain_types::AdminSignInRoute, super::api::sign_in),
    (server_admin_contract::domain_types::AdminRefreshRoute, super::api::refresh),
    (server_admin_contract::domain_types::AdminSignOutRoute, super::api::sign_out),
    (server_admin_contract::domain_types::AdminMeRoute, super::api::me),
    (server_admin_contract::domain_types::AdminChangeOwnPasswordRoute, super::api::change_own_password),
    (server_admin_contract::domain_types::AdminSessionsRoute, super::api::sessions),
    (server_admin_contract::domain_types::AdminRevokeSessionRoute, super::api::revoke_session),
    (server_admin_contract::domain_types::AdminRevokeAllSessionsRoute, super::api::revoke_all_sessions),
    (server_admin_contract::domain_types::AdminListUsersRoute, super::api::list_users),
    (server_admin_contract::domain_types::AdminCreateUserRoute, super::api::create_user),
    (server_admin_contract::domain_types::AdminUpdateUserRoute, super::api::update_user),
    (server_admin_contract::domain_types::AdminDeleteUserRoute, super::api::delete_user),
    (server_admin_contract::domain_types::AdminSetUserPasswordRoute, super::api::set_user_password),
    (server_admin_contract::domain_types::AdminSetUserBanRoute, super::api::set_user_ban),
    (server_admin_contract::domain_types::AdminSetUserRolesRoute, super::api::set_user_roles),
    (server_admin_contract::domain_types::AdminListRolesRoute, super::api::list_roles),
    (server_admin_contract::domain_types::AdminCreateRoleRoute, super::api::create_role),
    (server_admin_contract::domain_types::AdminUpdateRoleRoute, super::api::update_role),
    (server_admin_contract::domain_types::AdminDeleteRoleRoute, super::api::delete_role),
    (server_admin_contract::domain_types::AdminSetRolePermissionsRoute, super::api::set_role_permissions),
    (server_admin_contract::domain_types::AdminListPermissionsRoute, super::api::list_permissions),
    (server_admin_contract::domain_types::AdminAuditLogRoute, super::api::audit_log),
    (server_admin_contract::domain_types::AdminAuditExportRoute, super::api::export_audit_log),
    (server_admin_contract::domain_types::AdminBrandingRoute, super::api::branding),
    (server_admin_contract::domain_types::AdminSettingsRoute, super::api::settings),
    (server_admin_contract::domain_types::AdminUpdateSettingsRoute, super::api::update_settings),
    (server_admin_contract::domain_types::AdminDataTablesRoute, super::api::data_tables),
    (server_admin_contract::domain_types::AdminDataTableRoute, super::api::data_table),
)]
#[openapi(
