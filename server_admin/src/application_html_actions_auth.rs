...
pub(super) async fn sign_out(auth: super::super::super::AdminAuthReq) -> axum::response::Response {
    match super::super::form_auth_impl::form_auth_impl(auth) {
        Ok(auth) => match super::super::super::authn_sign_out::authn_sign_out(auth).await {
            Ok(response) => {
                let mut target =
...
pub(super) async fn change_password(
    ...
    match super::super::form_auth_impl::form_auth_impl(auth) {
        Ok(auth) => {
            ...
            match super::super::super::account_change_own_password::account_change_own_password(
                auth,
...
pub(super) async fn sign_in(
    ...
    let branding =
        super::super::super::settings_branding_view_ref::settings_branding_view_ref(&auth)
            .await
            .ok();
    match super::super::super::authn_sign_in::authn_sign_in(
        auth,
        peer,
