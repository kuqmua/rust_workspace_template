...
pub(crate) async fn api_login_attempts_table(
    ...
    crate::application_auth::AdminLoginAttemptsTableError,
> {
    ...
    .await
    .map_err(crate::application_auth::AdminLoginAttemptsTableError::from)
}
