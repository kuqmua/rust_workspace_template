...
pub enum AdminRoleRulesReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminRoleRulesReadPageError
{
...
impl From<crate::admin_repository_error::AdminRepositoryError> for AdminRoleRulesReadPageError {
...
impl to_err_string::to_err_string::ToErrString for AdminRoleRulesReadPageError {
