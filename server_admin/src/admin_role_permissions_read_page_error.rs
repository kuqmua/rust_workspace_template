...
pub enum AdminRolePermissionsReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminRolePermissionsReadPageError
{
...
impl to_err_string::to_err_string::ToErrString for AdminRolePermissionsReadPageError {
