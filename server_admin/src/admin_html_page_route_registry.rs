proc_macro_frontend_contract_route_registry::route_registry! {
    ...
    (server_admin_contract::admin_frontend_path::AdminFrontendPath::RolePermissionRead, crate::role_permission_read_page::role_permission_read_page),
    ...
    (server_admin_contract::admin_frontend_path::AdminFrontendPath::PermissionRead, crate::permission_read_page::permission_read_page),
