...
pub enum AdminPermissionResourceActionsReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminPermissionResourceActionsReadPageError
{
...
impl to_err_string::to_err_string::ToErrString for AdminPermissionResourceActionsReadPageError {
