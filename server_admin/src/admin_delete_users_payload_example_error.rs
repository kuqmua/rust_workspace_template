...
pub(crate) enum AdminDeleteUsersPayloadExampleError {
    #[error(
        "{}",
        constants_str::ADMIN_DELETE_USERS_PAYLOAD_EXAMPLE_USER_IDENTIFIER_ERROR
    )]
    UserIdentifier(
        #[source]
...
impl axum::response::IntoResponse for AdminDeleteUsersPayloadExampleError {
