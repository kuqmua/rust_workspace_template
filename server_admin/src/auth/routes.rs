...
#[frontend_contract::route_registry(
    ...
    (server_admin_contract::AdminMfaStatusRoute, super::mfa_status),
    (server_admin_contract::AdminMfaEnrollRoute, super::mfa_enroll),
    (server_admin_contract::AdminMfaConfirmRoute, super::mfa_confirm),
    (server_admin_contract::AdminMfaDisableRoute, super::mfa_disable),
    (server_admin_contract::AdminMfaStepUpRoute, super::mfa_step_up),
    ...
    (server_admin_contract::AdminDashboardRoute, super::dashboard),
