...
#[frontend_contract::route_openapi(delegate = super::authn::sign_in, tag = "admin_auth")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::account::me, tag = "admin_auth")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::authn::refresh, tag = "admin_auth")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::authn::sign_out, tag = "admin_auth")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::sessions::revoke_session, tag = "admin_auth")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::users::create, tag = "admin_users")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::users::update, tag = "admin_users")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::users::set_ban, tag = "admin_users")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::users::delete, tag = "admin_users")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::roles::create, tag = "admin_roles")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::roles::update, tag = "admin_roles")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::roles::delete, tag = "admin_roles")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::users::set_roles, tag = "admin_users")]
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::settings::branding, tag = "admin_settings")]
pub(super) async fn branding(
    auth: super::AdminAuthReq,
) -> Result<super::AxumAdminResponse, super::AdminBrandingError> {
}
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::data_tables::list, tag = "admin_tables")]
...
pub(super) async fn data_table(
    auth: super::AdminAuthReq,
    path: super::AxumAdminPath<server_admin_contract::AdminDataTable>,
    query: super::AxumAdminQuery<server_admin_contract::AdminDataTableQuery>,
...
#[allow(clippy::single_call_fn)] // Axum route handler is registered once by the route inventory
#[frontend_contract::route_openapi(delegate = super::settings::get, tag = "admin_settings")]
