#[allow(
    ...
    reason = "settings get remains a named owner because its boundary role is clearer and directly testable"
)]
pub(crate) async fn settings_get(
    ...
    let _actor = crate::authorization_authorize_generated_request::authorization_authorize_generated_request(
        ...
        *admin_auth_request.get_peer(),
        server_admin_contract::admin_rule::AdminRule::SystemSettingsRead.as_str(),
