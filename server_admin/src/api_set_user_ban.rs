...
#[frontend_contract::domain_types::route_openapi(delegate = super::users::mutations_set_ban::mutations_set_ban, tag = "admin_users")]
pub(super) async fn api_set_user_ban(
