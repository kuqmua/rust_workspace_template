...
pub(crate) async fn api_audit_log(
    ...
    crate::application_auth::AdminAuditLogError,
> {
    crate::audit_query_log::audit_query_log(admin_auth_request, axum_admin_query)
        .await
        .map_err(crate::application_auth::AdminAuditLogError::from)
}
