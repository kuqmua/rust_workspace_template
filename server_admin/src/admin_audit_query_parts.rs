...
pub(crate) struct AdminAuditQueryParts {
    ...
    pub(crate) user_id: Option<super::super::AdminUserId>,
    ...
    pub(crate) resource: Option<super::super::AdminAuditResource>,
    pub(crate) succeeded: Option<server_admin_contract::domain_types::AdminBool>,
    pub(crate) action: Option<super::super::AdminAuditAction>,
}
