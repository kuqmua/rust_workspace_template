...
pub enum AdminPermissionResourcesReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminPermissionResourcesReadPageError
{
...
impl to_err_string::to_err_string::ToErrString for AdminPermissionResourcesReadPageError {
