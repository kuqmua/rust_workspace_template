...
) -> Result<crate::domain_types::AdminRoleId, crate::domain_types::SqlxAdminError> {
...
) -> Result<server_admin_contract::domain_types::AdminRoleSummaries, super::AdminRepositoryError> {
    ...
    rows.into_iter()
        .map(|(id, name, is_system)| {
            Ok(server_admin_contract::domain_types::AdminRoleSummary::new(
                server_admin_contract::domain_types::AdminRoleId::try_from(id)
                    .map_err(super::invalid_stored_value)?,
                server_admin_contract::domain_types::AdminBool::from(is_system),
                server_admin_contract::domain_types::AdminRoleName::try_from(name)
                    .map_err(super::invalid_stored_value)?,
...
pub(crate) async fn replace_user_roles(
    ...
    expected_role_ids: &[server_admin_contract::domain_types::AdminRoleId],
    role_ids: &[server_admin_contract::domain_types::AdminRoleId],
) -> Result<super::ReplaceUserRolesOutcome, crate::domain_types::SqlxAdminError> {
