...
pub(crate) async fn enforce_rate_limit(
    ...
    scope: crate::domain_types::StdAdminStrRef<'_>,
    subject: &crate::domain_types::StdAdminString,
    limit: crate::domain_types::auth::StdAdminRateLimitCount,
    window_seconds: crate::domain_types::auth::StdAdminRateLimitWindowSeconds,
) -> Result<super::AdminRateLimitOutcome, super::AdminRateLimitRepositoryError> {
    server_runtime_http::domain_types::enforce_pg_rate_limit(
        server_runtime_http::domain_types::SqlxPgRateLimitPoolRef::from(pool.0),
        server_runtime_http::domain_types::PgRateLimitQueryRef::from(
            constants_str::SERVER_ADMIN_ENFORCE_RATE_LIMIT_SQL,
        ),
        server_runtime_http::domain_types::PgRateLimitScopeRef::try_from(scope.as_ref())
    ...
    .map_err(|error| match error {
        server_runtime_http::domain_types::PgRateLimitError::Sqlx(source) => {
            super::AdminRateLimitRepositoryError::Sqlx(crate::domain_types::SqlxAdminError::from(
                sqlx::Error::from(source),
            ))
        }
    })
    .map(|decision| match decision {
        server_runtime_http::domain_types::PgRateLimitDecision::Allowed => {
            super::AdminRateLimitOutcome::Allowed
        }
