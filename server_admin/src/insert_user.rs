...
) -> Result<server_admin_core::admin_user_id::AdminUserId, crate::sqlx_admin_error::SqlxAdminError>
{
    sqlx::query_scalar::<_, i64>(constants_str::integration_fixtures::SERVER_ADMIN_INSERT_USER_SQL)
        .bind(login.as_ref())
        ...
        .and_then(|value| {
            server_admin_core::admin_user_id::AdminUserId::try_from(value)
                .map_err(crate::sqlx_admin_error::SqlxAdminError::from)
        })
}
