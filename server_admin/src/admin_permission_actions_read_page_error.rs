...
pub enum AdminPermissionActionsReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminPermissionActionsReadPageError
{
...
impl to_err_string::to_err_string::ToErrString for AdminPermissionActionsReadPageError {
