...
pub enum AdminAuditLogReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminAuditLogReadPageError
{
...
impl From<crate::admin_repository_error::AdminRepositoryError> for AdminAuditLogReadPageError {
...
impl to_err_string::to_err_string::ToErrString for AdminAuditLogReadPageError {
