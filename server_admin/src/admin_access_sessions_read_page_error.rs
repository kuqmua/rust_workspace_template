...
pub enum AdminAccessSessionsReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminAccessSessionsReadPageError
{
...
impl to_err_string::to_err_string::ToErrString for AdminAccessSessionsReadPageError {
