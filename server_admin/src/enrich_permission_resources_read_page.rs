...
pub async fn enrich_permission_resources_read_page(
    list_items: pg_crud_common::list_items::ListItems<
        crate::admin_permission_resources::AdminPermissionResourcesRead,
    >,
    ...
    crate::admin_permission_resources_read_page_error::AdminPermissionResourcesReadPageError,
> {
