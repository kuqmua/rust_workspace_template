#[proc_macro_frontend_contract_route_error::route_error(AdminHtmlUserBanError)]
#[allow(
    clippy::single_call_fn,
    reason = "user ban remains a named owner because its boundary role is clearer and directly testable"
)]
