#[proc_macro_frontend_contract_route_error::route_error(AdminHtmlChangePasswordError)]
#[allow(
    clippy::single_call_fn,
    reason = "change password remains a named owner because its boundary role is clearer and directly testable"
)]
