#[proc_macro_frontend_contract_route_error::route_error(AdminPermissionReadPageError)]
#[allow(
    clippy::single_call_fn,
    reason = "typed frontend route registration requires a named endpoint function"
)]
pub(crate) async fn permission_read_page(
    ...
    let _admin_permission_id = axum_admin_path.into_inner();
