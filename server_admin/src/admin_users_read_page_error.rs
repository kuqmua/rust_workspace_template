...
pub enum AdminUsersReadPageError {
    ...
    RoleId(#[from] server_admin_contract::admin_id_try_from_i64_error::AdminIdTryFromI64Error),
    #[error("{message}", message = constants_str::ADMIN_DIAGNOSTIC_STORED_ADMIN_VALUE_DOES_NOT_SATISFY_ITS_CONTRACT)]
    StoredRole,
    #[error("{message}", message = constants_str::ADMIN_DIAGNOSTIC_STORED_ADMIN_VALUE_DOES_NOT_SATISFY_ITS_CONTRACT)]
...
impl to_err_string::to_err_string::ToErrString for AdminUsersReadPageError {
...
impl From<crate::admin_repository_error::AdminRepositoryError> for AdminUsersReadPageError {
