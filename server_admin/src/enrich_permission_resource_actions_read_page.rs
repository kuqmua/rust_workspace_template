...
pub async fn enrich_permission_resource_actions_read_page(
    list_items: pg_crud_common::list_items::ListItems<
        crate::admin_permission_resource_actions::AdminPermissionResourceActionsRead,
    >,
    ...
    crate::admin_permission_resource_actions_read_page_error::AdminPermissionResourceActionsReadPageError,
>{
