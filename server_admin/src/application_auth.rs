...
proc_macro_frontend_contract_api_operation_error::api_operation_error!(AdminDeleteUserError,);
...
proc_macro_frontend_contract_api_operation_error::api_operation_error!(AdminListUsersError,);
