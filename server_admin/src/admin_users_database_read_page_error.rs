...
pub enum AdminUsersDatabaseReadPageError {
...
impl From<server_admin_contract::admin_text::AdminTextTryFromStringError>
    for AdminUsersDatabaseReadPageError
{
...
impl From<crate::admin_repository_error::AdminRepositoryError> for AdminUsersDatabaseReadPageError {
...
impl to_err_string::to_err_string::ToErrString for AdminUsersDatabaseReadPageError {
