...
#[frontend_contract::domain_types::route_registry(
    ...
    (server_admin_contract::domain_types::AdminSignInRoute, super::api_sign_in::api_sign_in),
    (server_admin_contract::domain_types::AdminRefreshRoute, super::api_refresh::api_refresh),
    (server_admin_contract::domain_types::AdminSignOutRoute, super::api_sign_out::api_sign_out),
    (server_admin_contract::domain_types::AdminMeRoute, super::api_me::api_me),
    (server_admin_contract::domain_types::AdminChangeOwnPasswordRoute, super::api_change_own_password::api_change_own_password),
    (server_admin_contract::domain_types::AdminSessionsRoute, super::api_sessions::api_sessions),
    (server_admin_contract::domain_types::AdminRevokeSessionRoute, super::api_revoke_session::api_revoke_session),
    (server_admin_contract::domain_types::AdminRevokeAllSessionsRoute, super::api_revoke_all_sessions::api_revoke_all_sessions),
    (server_admin_contract::domain_types::AdminListUsersRoute, super::api_list_users::api_list_users),
    (server_admin_contract::domain_types::AdminCreateUserRoute, super::api_create_user::api_create_user),
    (server_admin_contract::domain_types::AdminUpdateUserRoute, super::api_update_user::api_update_user),
    (server_admin_contract::domain_types::AdminDeleteUserRoute, super::api_delete_user::api_delete_user),
    (server_admin_contract::domain_types::AdminSetUserPasswordRoute, super::api_set_user_password::api_set_user_password),
    (server_admin_contract::domain_types::AdminSetUserBanRoute, super::api_set_user_ban::api_set_user_ban),
    (server_admin_contract::domain_types::AdminSetUserRolesRoute, super::api_set_user_roles::api_set_user_roles),
    (server_admin_contract::domain_types::AdminListRolesRoute, super::api_list_roles::api_list_roles),
    (server_admin_contract::domain_types::AdminCreateRoleRoute, super::api_create_role::api_create_role),
    (server_admin_contract::domain_types::AdminUpdateRoleRoute, super::api_update_role::api_update_role),
    (server_admin_contract::domain_types::AdminDeleteRoleRoute, super::api_delete_role::api_delete_role),
    (server_admin_contract::domain_types::AdminSetRolePermissionsRoute, super::api_set_role_permissions::api_set_role_permissions),
    (server_admin_contract::domain_types::AdminListPermissionsRoute, super::api_list_permissions::api_list_permissions),
    (server_admin_contract::domain_types::AdminAuditLogRoute, super::api_audit_log::api_audit_log),
    (server_admin_contract::domain_types::AdminAuditExportRoute, super::api_export_audit_log::api_export_audit_log),
    (server_admin_contract::domain_types::AdminBrandingRoute, super::api_branding::api_branding),
    (server_admin_contract::domain_types::AdminSettingsRoute, super::api_settings::api_settings),
    (server_admin_contract::domain_types::AdminUpdateSettingsRoute, super::api_update_settings::api_update_settings),
    (server_admin_contract::domain_types::AdminDataTablesRoute, super::api_data_tables::api_data_tables),
    (server_admin_contract::domain_types::AdminDataTableRoute, super::api_data_table::api_data_table),
)]
#[openapi(
