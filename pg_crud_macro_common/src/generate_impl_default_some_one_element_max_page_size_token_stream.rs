...
pub fn generate_impl_default_some_one_element_max_page_size_token_stream(
    ...
    #[allow(
        non_snake_case,
        reason = "generate impl default some one element max page size token stream requires this localized allowance for generated or framework-constrained code verified by focused tests"
    )]
