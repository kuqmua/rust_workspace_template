...
pub fn generate_impl_all_variants_default_some_one_element_token_stream(
    ...
    #[allow(
        non_snake_case,
        reason = "generate impl all variants default some one element token stream requires this localized allowance for generated or framework-constrained code verified by focused tests"
    )]
