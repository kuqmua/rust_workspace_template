...
fn generate_impl_new_for_identifier_token_stream_generates_non_const_new() {
    ...
    let ts = super::generate_impl_new_for_identifier_token_stream_impl(
        &identifier,
        &empty_token_stream(),
        &parameters,
        &body,
...
fn generate_impl_const_new_for_identifier_token_stream_generates_const_new() {
    ...
    let ts = super::generate_impl_const_new_for_identifier_token_stream_impl(
        &identifier,
        &empty_token_stream(),
        &parameters,
        &body,
...
fn generate_impl_pub_const_new_for_identifier_token_stream_generates_pub_const_new() {
    ...
    let ts = super::generate_impl_pub_const_new_for_identifier_token_stream_impl(
        &identifier,
        &attr,
        &parameters,
        &body,
