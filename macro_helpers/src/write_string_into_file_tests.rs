...
mod tests {
    ...
    fn try_write_string_into_path_writes_exact_path_without_extension_rewrite() {
        ...
        let result_path = crate::try_write_string_into_path_tests::try_write_string_into_path(&path, file_content(constants_str::catalog::ABC_ALT_3))
    ...
    fn should_write_string_into_file_returns_true_for_missing_file() {
        ...
        let should_write =
            crate::should_write_string_into_file_tests::should_write_string_into_file(path_ref(&path), file_content(constants_str::catalog::ABC_ALT_3))
    ...
    fn should_write_string_into_file_returns_false_when_content_is_eq() {
        ...
        let should_write =
            crate::should_write_string_into_file_tests::should_write_string_into_file(path_ref(&path), file_content(constants_str::catalog::SAME))
    ...
    fn should_write_string_into_file_returns_true_when_content_differs() {
        ...
        let should_write =
            crate::should_write_string_into_file_tests::should_write_string_into_file(path_ref(&path), file_content(constants_str::catalog::NEW))
    ...
    fn should_write_string_into_file_returns_true_for_same_len_diff_content() {
        ...
        let should_write =
            crate::should_write_string_into_file_tests::should_write_string_into_file(path_ref(&path), file_content(constants_str::catalog::XYZ))
    ...
    fn should_write_string_into_file_returns_true_for_diff_len_content() {
        ...
        let should_write =
            crate::should_write_string_into_file_tests::should_write_string_into_file(path_ref(&path), file_content(constants_str::catalog::A_ALT))
    ...
    fn write_string_if_needed_returns_false_without_rewrite_for_eq_content() {
        ...
        let wrote = crate::write_string_if_needed_tests::write_string_if_needed(path_ref(&path), file_content(constants_str::catalog::SAME))
    ...
    fn write_string_if_needed_returns_true_and_writes_for_diff_content() {
        ...
        let wrote = crate::write_string_if_needed_tests::write_string_if_needed(path_ref(&path), file_content(constants_str::catalog::NEW))
    ...
    fn try_write_string_into_path_with_outcome_returns_changed_for_new_content() {
        ...
        let outcome =
            crate::try_write_string_into_path_with_outcome_tests::try_write_string_into_path_with_outcome(&path, file_content(constants_str::catalog::ABC_ALT_3))
