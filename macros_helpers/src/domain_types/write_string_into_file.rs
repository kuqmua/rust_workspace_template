...
mod tests {
    ...
    fn txt_path(name: &str) -> std::path::PathBuf {
        crate::domain_types::test_hlp::test_path(crate::domain_types::test_hlp::TestPathStem::new(
            name,
        ))
        .as_ref()
    ...
    fn assert_content_and_cleanup(path: &std::path::Path, expected: &str) {
        crate::domain_types::test_hlp::assert_file_content(
            crate::domain_types::test_hlp::StdAssertFilePath::new(path),
    ...
    fn path_with_rs_extension_accepts_path_input() {
        let path = crate::domain_types::rs_file_path::rs_file_path(
            crate::domain_types::test_hlp::test_path(
                crate::domain_types::test_hlp::TestPathStem::new(
                    constants_str::MACROS_HELPERS_RS_EXT_PATH,
                ),
            ),
        );
        assert_eq!(
    ...
    fn try_write_string_into_path_with_outcome_returns_changed_for_new_content() {
        ...
        crate::domain_types::test_hlp::assert_file_content(
            crate::domain_types::test_hlp::StdAssertFilePath::new(&path),
            crate::domain_types::test_hlp::ExpectedFileContent::new(constants_str::ABC_ALT_3),
        );
