...
constants_str_macros::define_str_constants! {
    ...
    constants {
        ...
        CONSTANTS_STR_MACROS_SRC_DEFINE_STR_CONSTANTS_INPUT_RS = ["constants_str_macros/src/define_str_constants_input.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_DOMAIN_TYPES_WITH_OWNER_NAVIGATION_RS = ["server_admin_frontend/src/domain_types_with_owner_navigation.rs"];
        SERVER_ADMIN_FRONTEND_SRC_DOMAIN_TYPES_WITH_OWNER_TABLE_RS = ["server_admin_frontend/src/domain_types_with_owner_table.rs"];
        SERVER_ADMIN_FRONTEND_SRC_WITH_OWNER_RS = ["server_admin_frontend/src/with_owner.rs"];
        SERVER_RUNTIME_CORE_SRC_ASYNC_RUN_HISTORY_SNAPSHOT_RS = ["server_runtime_core/src/async_run_history_snapshot.rs"];
        DECLARED_CHILDREN = ["DECLARED_CHILDREN"];
        MODULE_DECLARATION_GRAPH_IS_CACHED_FOR_REPOSITORY_POLICY_MATCHING = ["module declaration graph is cached for repository policy matching"];
        OWNER_DERIVED_MODULE_IS_COVERED_BY_ITS_FACADE_LEVEL_TESTS = ["owner-derived module is covered by its facade-level tests"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_APP_NAVIGATION_RS = ["server_admin_frontend/src/csr_admin_nav.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_APP_ROLES_ROW_RS = ["server_admin_frontend/src/csr_admin_role_row.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_APP_USERS_ROW_RS = ["server_admin_frontend/src/csr_admin_user_row.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_SSR_ROLES_ROW_RS = ["server_admin_frontend/src/ssr_admin_role_row.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_SSR_DOCUMENT_PAGE_NAVIGATION_RS = ["server_admin_frontend/src/ssr_admin_nav.rs"];
        ...
        SERVER_ADMIN_FRONTEND_SRC_SSR_USERS_ROW_RS = ["server_admin_frontend/src/ssr_admin_user_row.rs"];
