...
pub const CODE_STYLE_DIRECT_FS_OWNER_SUFFIXES: [&str; 20] = [
    ...
    "/administrator_account_initialization_and_password_reset/src/parse_args.rs",
...
pub const CODE_STYLE_FACADE_REEXPORT_SUFFIXES: [&str; 38] = [
    ...
    "pg_crud_pg_table_generate_src/src/table.rs",
    ...
    "server_admin_contract/src/identifier.rs",
    ...
    "server_observability/src/capture.rs",
...
pub const CODE_STYLE_FACADE_REEXPORT_REASONS: [&str; 38] = [
    ...
    "bounded vector facade preserves the public collection path across owner modules",
    "configuration domain facade exports its public typed configuration API",
    "configuration boolean facade preserves flag and parsing types across owner modules",
    ...
    "PG table model facade preserves generator descriptor paths across owner modules",
    ...
    "administrator identifier facade preserves its public typed API across owner modules",
    "administrator session facade preserves its public typed API across owner modules",
    ...
    "observed-error facade preserves diagnostic wrapper types across owner modules",
    "server runtime core facade exports dependency-light runtime primitives",
    "exclusive-run facade preserves lifecycle guard types across owner modules",
    "run-history facade preserves history and snapshot types across owner modules",
