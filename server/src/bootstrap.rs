...
) -> super::SharedServerAppStateArc {
    super::SharedServerAppStateArc::from(std::sync::Arc::new(
...
pub(super) fn mk_runtime() -> Result<super::TokioServerRuntime, super::RunServerError> {
    tokio::runtime::Builder::new_multi_thread()
        ...
        .map_err(|error| super::RunServerError::BuildRuntime(super::ServerIoError::from(error)))
}

pub(super) async fn mk_pg_pool(
    config: &server_config::domain_types::Config,
) -> Result<app_state::domain_types::SqlxPgPool, super::RunServerError> {
