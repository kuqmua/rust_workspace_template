...
| `HttpNotificationApiProblem` | `struct` | `private` | single-field tuple wrapper; production | **Нет** | Не требуется | inner фиксирован, заимствован или уже валидирован своим типом | [`notification_service/src/main.rs:25`](../notification_service/src/main.rs#L25) |
