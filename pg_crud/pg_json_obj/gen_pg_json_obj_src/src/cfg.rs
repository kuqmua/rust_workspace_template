...
#[derive(Debug, Clone, Copy, PartialEq, Serialize, Deserialize, Optml)]
pub enum TraitGen {
    PgJson,
    PgTypeAndPgJson,
}
#[allow(clippy::arbitrary_source_item_ordering)]
#[derive(Debug, Clone, Copy, PartialEq, Serialize, Deserialize, Display, EnumIter, Optml)]
pub enum Pattern {
    Stdrt,
    Arr,
}
...
#[derive(Debug, Clone, Copy, Deserialize, Optml)]
