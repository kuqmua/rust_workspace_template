...
pub fn gen_wh_flts(input_ts: ProcMacro2GenWhFltsInput<'_>) -> ProcMacro2GenWhFltsTs {
    ...
    let text_search_schema_ts = crate::schema::text_search_ts(text_search_spec);
    let text_search_client_ts = crate::client::text_search_ts(text_search_spec);
    let text_search_bind_ts = crate::bind::text_search_ts(text_search_spec);
    let text_search_ts = quote::quote! {
        #text_search_schema_ts
        #text_search_client_ts
        #text_search_bind_ts
    };
