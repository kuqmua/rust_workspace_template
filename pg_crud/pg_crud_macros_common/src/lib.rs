...
impl FromIterator<macros_helpers::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream>
    for ProcMacro2GeneratedRustTokenStreamVec
{
    fn from_iter<T>(iter: T) -> Self
    where
        T: IntoIterator<
            Item = macros_helpers::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream,
        >,
    {
...
impl IsNullable {
    ...
    pub fn maybe_optional_wrap(
        &self,
        ts: macros_helpers::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream,
...
impl Import {
    fn all_enum_variants(
        ...
        macros_helpers::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream::from(match self {
    ...
    T: filters::PgFilter,
{
    ...
    let pg_type_tokens_where_token_stream = {
        let vrts_token_stream = variants.iter().map(|element| {
            ...
            let optional_type_token_stream: Option<macros_helpers::proc_macro2_tokens::ProcMacro2GeneratedRustTokenStream> =
