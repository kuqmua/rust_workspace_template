...
pub(crate) fn write_admin_contract_fixture() -> Result<(), ()> {
    ...
    let permission_values = server_admin_contract::domain_types::AdminPermission::ALL
        .into_iter()
        .map(|permission| {
            admin_fixture_string::<server_admin_contract::domain_types::AdminPermissionValue>(
                permission.as_str().as_ref().to_owned(),
            )
        })
        .collect::<Result<Vec<_>, ()>>()?;
    let authenticated_admin = server_admin_contract::domain_types::AuthenticatedAdmin::new(
        admin_fixture_string::<server_admin_contract::domain_types::AdminDisplayName>(
            String::from(constants_str::ADMIN),
        )?,
        server_admin_contract::domain_types::AdminUserId::try_from(constants_i64::ONE)
            .map_err(|error| eprintln!("{error}"))?,
        admin_fixture_string::<server_admin_contract::domain_types::AdminLogin>(String::from(
            constants_str::ROOT,
        ))?,
        ...
        server_admin_contract::domain_types::AdminRoleNames::try_from(vec![
            admin_fixture_string::<server_admin_contract::domain_types::AdminRoleName>(
    ...
    let users = (constants_i64::ZERO..25i64)
        .map(|index| {
            ...
            Ok(server_admin_contract::domain_types::AdminUserSummary::new(
                ...
                admin_fixture_string::<server_admin_contract::domain_types::AdminLogin>(
                    if is_alpha {
        ...
        .map(|(index, permission)| {
            ...
            Ok(
                server_admin_contract::domain_types::AdminPermissionSummary::new(
                    server_admin_contract::domain_types::AdminPermissionId::try_from(identifier)
                        .map_err(|error| eprintln!("{error}"))?,
                    permission,
                ),
            )
    ...
    let role_summary = server_admin_contract::domain_types::AdminRoleSummary::new(
        ...
        admin_fixture_string::<server_admin_contract::domain_types::AdminRoleName>(String::from(
    ...
    let audit_details = server_admin_contract::domain_types::SerdeJsonAdminAuditDetails::try_from(
        serde_json::json!({
    ...
    let audit = vec![server_admin_contract::domain_types::AdminAuditView::new(
        admin_fixture_string::<server_admin_contract::domain_types::AdminText>(String::from(
            constants_str::ADMIN_FIXTURE_AUDIT_ACTION,
        ))?,
        admin_fixture_string::<server_admin_contract::domain_types::AdminAuditTimestamp>(
    ...
    let sessions = vec![
        server_admin_contract::domain_types::AdminSessionView::new(
            admin_fixture_string::<server_admin_contract::domain_types::AdminSessionTimestamp>(
                String::from(constants_str::ADMIN_FIXTURE_SESSION_CREATED_AT),
            )?,
            admin_fixture_string::<server_admin_contract::domain_types::AdminSessionTimestamp>(
                String::from(constants_str::ADMIN_FIXTURE_SESSION_EXPIRES_AT),
            )?,
            admin_fixture_string::<server_admin_contract::domain_types::AdminSessionIdentifier>(
    ...
    let users_page = server_admin_contract::domain_types::AdminUsersPage::new(
        server_admin_contract::domain_types::AdminUserSummaries::try_from(users)
            .map_err(|error| eprintln!("{error}"))?,
        server_admin_contract::domain_types::AdminRoleSummaries::try_from(role_summaries.clone())
            .map_err(|error| eprintln!("{error}"))?,
