...
#[serde(try_from = "u16")]
#[try_from(
    error = crate::domain_types::HttpStatusTryFromU16Error,
...
impl ApiProblemError {
    ...
    pub fn status(self) -> ApiProblemStatus {
        match self {
            Self::Authentication => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::Unauthorized)
            }
            Self::Authorization => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::Forbidden)
            }
            Self::Conflict => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::Conflict)
            }
            Self::InProgress => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::TooEarly)
            }
            Self::Internal(status) | Self::RequestFailed(status) => status,
            Self::InvalidRequest => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::BadRequest)
            }
            Self::MethodNotAllowed => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::MethodNotAllowed)
            }
            Self::NotFound => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::NotFound)
            }
            Self::PayloadTooLarge => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::PayloadTooLarge)
            }
            Self::Precondition => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::PreconditionFailed)
            }
            Self::PreconditionRequired => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::PreconditionRequired)
            }
            Self::RateLimited => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::TooManyRequests)
            }
            Self::ServiceUnavailable => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::ServiceUnavailable)
            }
            Self::Validation => {
                ApiProblemStatus::from(crate::domain_types::KnownHttpStatus::UnprocessableEntity)
            }
        }
    }
}
