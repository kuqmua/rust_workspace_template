    ...
    Transport: crate::domain_types::Transport,
{
        ...
        Route: crate::domain_types::TypedRoute,
    {
        ...
        .map_err(|error| {
            crate::domain_types::ClientError::Encode(super::form_value_error(error))
        })?;
    ...
    pub async fn send_contract(
        ...
        let transport_path =
            crate::domain_types::TransportPath::try_from(route_path.as_ref().to_owned()).map_err(
                |error| crate::domain_types::ClientError::Encode(super::form_value_error(error)),
            )?;
        let transport_body =
        ...
        Route: crate::domain_types::TypedRoute,
    {
        ...
        serde_json::from_slice(bytes).map_err(|error| {
            crate::domain_types::ClientError::Decode(super::form_value_error(error))
        })
    }
    #[allow(clippy::future_not_send)] // Transport intentionally permits single-threaded WASM futures
